...
!** USE STATEMENTS:
    ...
    USE ModBase_DoublyLinkedLists,   ONLY: QueueChar => ListCharacter
...
!** MODULE PARAMETERS:
    ! name of module
    tCharParam          :: ModName = 'ModBase_ChrStr'
    !------------------------------------------------------------------
    !-----                  FailIndex parameters                  -----
    !------------------------------------------------------------------
    !% unknown index
    tInteger, PARAMETER, PUBLIC     :: ID_UNKNOWN_INDEX     = -5
    !% character string not yet allocated
    tInteger, PARAMETER, PUBLIC     :: ID_NOT_ALLOCATED     = -4
    !% character string with zero length
    tInteger, PARAMETER, PUBLIC     :: ID_ZERO_LENGTH       = -3
    !% missing character
    tInteger, PARAMETER, PUBLIC     :: ID_MISSING_CHARACTER = -2
    !% empty string
    tInteger, PARAMETER, PUBLIC     :: ID_EMPTY_STRING      = -1
    !% fail index not applicable
    tInteger, PARAMETER, PUBLIC     :: ID_NO_FAILINDEX      =  0
...
!** INTERFACE DEFINITIONS:
    ...
    INTERFACE IsStringInClass
        ...
        RECURSIVE MODULE FUNCTION IsStringInClass(cStr,ClassType,FailIndex) RESULT(ClassFlag)
            ...
            !  (see the <a href="../module/modbase_chrstr.html#interface-ischaracterinclass">
    ...
    INTERFACE CountCharactersProtect
        ...
        MODULE FUNCTION CountCharactersProtect(cStr,ChrSet,ExclMrk) RESULT(nCount)
            ...
            !  See the <a href="../module/modbase_chrstr.html#interface-findprotectedregions">
    ...
    INTERFACE FindSeparatorsProtect
        ...
        MODULE FUNCTION FindSeparatorsProtect(cStr,Separator,CharSet,sPos,ExclMrk) RESULT(nCount)
            ...
            !  position(s) of the separator(s) found. <br>
            !  See the <a href="../module/modbase_chrstr.html#interface-findseparators">
    ...
    INTERFACE RemoveCharactersProtect
        ...
        MODULE FUNCTION RemoveCharactersProtect(cStrIn,ChrSet,Option,ExclMrk) RESULT(cStrOut)
            ...
            !  See the <a href="../module/modbase_chrstr.html#interface-removecharacters">
