...
MODULE Class_IntrusiveHashTree
...
!** USE STATEMENTS:
    ...
    USE Class_IntrusiveBSTrees,         ONLY: BSTNode, IntrusiveRBTree
...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_IntrusiveHashTree'
...
!** DERIVED TYPE DEFINITIONS
    ...
    CONTAINS
        ...
        !  **Purpose**:  To compute hash code of the key component of the *HashTreeNode* object. <br>
        !  **Usage**: <br>
...
!** INTERFACE DEFINITIONS:
    ABSTRACT INTERFACE
        ...
        FUNCTION EqualKey(LhsObj, RhsObj) RESULT(Flag)
            IMPORT
            CLASS(HashTreeNode), INTENT(IN) :: LhsObj   !! an object
            CLASS(HashTreeNode), INTENT(IN) :: RhsObj   !! another object
...
END MODULE Class_IntrusiveHashTree
