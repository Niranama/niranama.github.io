...
!** MODULE PARAMETERS:
    tInteger, PARAMETER :: N = 16   ! length of array X
...
! FLOW
    ...
    END DO
    CALL L64X1024RNG_SetParameters(RNG, Mix_Murmur(InitSeed), 1_kLong, X)
