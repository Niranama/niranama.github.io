...
!** USE STATEMENTS:
    ...
    USE Class_MDEngine
    USE Class_GroestlS,             ONLY: T0, T1, T2, T3, T4, T5, T6, T7
...
! FLOW
    ...
    MD%BufArr  = 0_kByte
    MD%H(0:14) = 0_kLong
    MD%H(15)   = SHIFTL(ToLong(MD%GetDigestLen()), 3)
    CALL MD%EngineReset()
...
CONTAINS
    ...
    ! FLOW
        ...
        DO R = 0, 13, 2
            ...
            X( 8) = QC64(X( 8), ToInteger(Z'00000081'), R)
            X( 9) = QC64(X( 9), ToInteger(Z'00000091'), R)
            X(10) = QC64(X(10), ToInteger(Z'000000A1'), R)
            X(11) = QC64(X(11), ToInteger(Z'000000B1'), R)
            X(12) = QC64(X(12), ToInteger(Z'000000C1'), R)
            X(13) = QC64(X(13), ToInteger(Z'000000D1'), R)
            X(14) = QC64(X(14), ToInteger(Z'000000E1'), R)
            X(15) = QC64(X(15), ToInteger(Z'000000F1'), R)
            ...
            T( 8) = QC64(T( 8), ToInteger(Z'00000081'), RP1)
            T( 9) = QC64(T( 9), ToInteger(Z'00000091'), RP1)
            T(10) = QC64(T(10), ToInteger(Z'000000A1'), RP1)
            T(11) = QC64(T(11), ToInteger(Z'000000B1'), RP1)
            T(12) = QC64(T(12), ToInteger(Z'000000C1'), RP1)
            T(13) = QC64(T(13), ToInteger(Z'000000D1'), RP1)
            T(14) = QC64(T(14), ToInteger(Z'000000E1'), RP1)
            T(15) = QC64(T(15), ToInteger(Z'000000F1'), RP1)
...
! FLOW
    ...
    DO R = 0, 13, 2
        ...
        X( 8) = PC64(X( 8), ToInteger(Z'00000080'), R)
        X( 9) = PC64(X( 9), ToInteger(Z'00000090'), R)
        X(10) = PC64(X(10), ToInteger(Z'000000A0'), R)
        X(11) = PC64(X(11), ToInteger(Z'000000B0'), R)
        X(12) = PC64(X(12), ToInteger(Z'000000C0'), R)
        X(13) = PC64(X(13), ToInteger(Z'000000D0'), R)
        X(14) = PC64(X(14), ToInteger(Z'000000E0'), R)
        X(15) = PC64(X(15), ToInteger(Z'000000F0'), R)
        ...
        T( 8) = PC64(T( 8), ToInteger(Z'00000080'), RP1)
        T( 9) = PC64(T( 9), ToInteger(Z'00000090'), RP1)
        T(10) = PC64(T(10), ToInteger(Z'000000A0'), RP1)
        T(11) = PC64(T(11), ToInteger(Z'000000B0'), RP1)
        T(12) = PC64(T(12), ToInteger(Z'000000C0'), RP1)
        T(13) = PC64(T(13), ToInteger(Z'000000D0'), RP1)
        T(14) = PC64(T(14), ToInteger(Z'000000E0'), RP1)
        T(15) = PC64(T(15), ToInteger(Z'000000F0'), RP1)
