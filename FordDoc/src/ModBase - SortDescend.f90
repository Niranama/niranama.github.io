...
!   See the <a href="../module/modbase_sortascend.html">ModBase_SortAscend</a> module
!   for routines that perform sorting of an array in an *ascending* order.  Also, the
!   *ModBase_SortAscend* module gives an overview of available sorting algorithms, which
!   are the same as the algorithms available in this module.  For ranking an array in
!   an *ascending* order, see the <a href="../module/modbase_ranking.html">ModBase_Ranking</a>
!   module. <br>
...
!** MODULE PARAMETERS:
    tCharParam  :: ModName = 'ModBase_SortDescend'
...
!** INTERFACE DEFINITIONS:
    ...
    INTERFACE WiseSort
        ...
        MODULE SUBROUTINE Wise_SortR64(A)
            tDouble, INTENT(INOUT)  :: A(:)
        END SUBROUTINE
        MODULE SUBROUTINE Wise_SortR128(A)
            tQuad,   INTENT(INOUT)  :: A(:)
        END SUBROUTINE
    ...
    INTERFACE TimSort
        ...
        MODULE SUBROUTINE Tim_SortR32(A)
            tSingle, INTENT(INOUT), TARGET  :: A(:)
        END SUBROUTINE
        MODULE SUBROUTINE Tim_SortR64(A)
            tDouble, INTENT(INOUT), TARGET  :: A(:)
        END SUBROUTINE
        MODULE SUBROUTINE Tim_SortR128(A)
            tQuad,   INTENT(INOUT), TARGET  :: A(:)
        END SUBROUTINE
    ...
    INTERFACE MergeSortBottomUp
        ...
        END SUBROUTINE
    END INTERFACE
    INTERFACE MergeSortQuadSplit
        !^ **Subroutine Interface**: MergeSortQuadSplit <br>
        !  **Purpose**:  To sort an array in a desired order using a *top-down
...
END MODULE ModBase_SortDescend
