...
MODULE ModBase_ReferenceHash32
...
!   <a href="../module/modbase_simplehash32.html">ModBase_SimpleHash32</a> module.
!   The main difference between routines in these two modules is that routines in
!   the *ModBase_SimpleHash32* module process input data one byte at a time whereas
...
END MODULE ModBase_ReferenceHash32
