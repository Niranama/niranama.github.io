...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_IntrusiveBSTrees'
...
!** DERIVED TYPE DEFINITIONS
    ...
    !   noted that this new type is in both the *Assignable* and *Comparable* classes.
    ...
    !   deferred procedures required by an *Assignable* object. <br>
    ...
    TYPE, ABSTRACT, EXTENDS(Comparable)  :: BSTNode
        PRIVATE
    ...
    CONTAINS
        ...
        !  **Usage**: <br>
        !   --->    CALL Node%Reset()
        PROCEDURE   :: Reset        => BSTNode_Reset
        !> **Type-Bound Subroutine**: CopyMembers <br>
        ...
        !                by an object in the *Assignable* class. <br>
        !  **Usage**: <br>
        !   --->    CALL DstNode%CopyMembers(SrcNode)
        PROCEDURE   :: CopyMembers  => BSTNode_CopyMembers
        ...
        !                required by an object in the *Assignable* class. <br>
        !  **Usage**: <br>
        !   --->    Flag = LhsNode%EqualTo(RhsNode) <br>
        !   --->    IF (.NOT.LhsNode%EqualTo(RhsNode)) DoSomething
        PROCEDURE   :: EqualTo      => BSTNode_EqualTo
        ! ---------------------------------------------------------------------
    END TYPE BSTNode
...
SUBROUTINE BSTNode_CopyMembers(DstNode, SrcNode)
...
END SUBROUTINE BSTNode_CopyMembers
...
END MODULE Class_IntrusiveBSTrees
