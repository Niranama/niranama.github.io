...
!** USE STATEMENTS:
    ...
    USE ModBase_Common
    USE ModLib_FLC_Algorithm
    USE ModLib_FLC_Random
    USE ModLib_FLC_String,  ONLY: CStd_String => String, CStd_S2F => stof, CStd_S2D => stod, &
                                  CStd_S2I => stoi, CStd_S2L => stoll
    USE ModLib_FLC_Map,     ONLY: CStd_MapII => MapIntInt, CStd_MapSI => MapStringInt, &
                                  CStd_MapSS => MapStringString
    USE ModLib_FLC_Set,     ONLY: CStd_SetInt => SetInt, CStd_SetStr => SetString
    USE ModLib_FLC_Vector,  ONLY: CStd_VecI32 => VectorInt4, CStd_VecI64 => VectorInt8, &
...
!** MODULE PARAMETERS:
    tCharStar, PARAMETER    :: ModName = 'ModBase_CppStdUtil'   ! module name
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tIndex,  INTENT(INOUT)  :: Ind(SIZE(Arr))
