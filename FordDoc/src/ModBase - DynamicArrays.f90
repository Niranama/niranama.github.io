...
!   or a derived type in the *Assignable* class (i.e. the *Assignable* type or its subtypes). <br>
!   Available container types are: <br>
!   - the <a href="../module/class_darrcharacter.html#type-darrcharacter">DArrCharacter</a> type
!     for character string type, <br>
!   - the <a href="../module/class_darrcmpxsp.html#type-darrcmpxsp">DArrCmpxSP</a> type
!     for single-precision complex type, <br>
!   - the <a href="../module/class_darrcmpxdp.html#type-darrcmpxdp">DArrCmpxDP</a> type
!     for double-precision complex type, <br>
!   - the <a href="../module/class_darrcmpxqp.html#type-darrcmpxqp">DArrCmpxQP</a> type
!     for quadruple-precision complex type, <br>
!   - the <a href="../module/class_darrinteger1b.html#type-darrinteger1b">DArrInteger1B</a> type
!     for 1-byte (or 8-bit) integer type, <br>
!   - the <a href="../module/class_darrinteger2b.html#type-darrinteger2b">DArrInteger2B</a> type
!     for 2-byte (or 16-bit) integer type, <br>
!   - the <a href="../module/class_darrinteger4b.html#type-darrinteger4b">DArrInteger4B</a> type
!     for 4-byte (or 32-bit) integer type, <br>
!   - the <a href="../module/class_darrinteger8b.html#type-darrinteger8b">DArrInteger8B</a> type
!     for 8-byte (or 64-bit) integer type, <br>
!   - the <a href="../module/class_darrlogical.html#type-darrlogical">DArrLogical</a> type
!     for default logical type, <br>
!   - the <a href="../module/class_darrrealsp.html#type-darrrealsp">DArrRealSP</a> type
!     for single-precision real type, <br>
!   - the <a href="../module/class_darrrealdp.html#type-darrrealdp">DArrRealDP</a> type
!     for double-precision real type, <br>
!   - the <a href="../module/class_darrrealqp.html#type-darrrealqp">DArrRealQP</a> type
!     for quadruple-precision real type, and <br>
!   - the <a href="../module/class_darrassignable.html#type-darrassignable">DArrAssignable</a> type
!     for a derived type in the *Assignable* class. <br>
...
!   <a href="../module/modbase_doublylinkedlist.html">ModBase_DoublyLinkedList</a> module
...
!   be noted that all *dynamic-array-based* types provided in the *Class_DynamicArrays*
...
!   items to be stored whereas each individual type in the *Class_DynamicArrays*
...
!** USE STATEMENTS:
    USE Class_DArrCharacter
    USE Class_DArrCmpxSP
    USE Class_DArrCmpxDP
    USE Class_DArrCmpxQP
    USE Class_DArrInteger1B
    USE Class_DArrInteger2B
    USE Class_DArrInteger4B
    USE Class_DArrInteger8B
    USE Class_DArrLogical
    USE Class_DArrRealSP
    USE Class_DArrRealDP
    USE Class_DArrRealQP
    USE Class_DArrAssignable

END MODULE ModBase_DynamicArrays
