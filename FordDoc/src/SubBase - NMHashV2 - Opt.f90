...
SUBMODULE (ModBase_OptimalHash32) SubBase_NMHashV2_Opt

!^ **PURPOSE OF THIS SUBMODULE**: <br>
!   This submodule contains an optimal implementation for version 2 of the NM hash algorithms
!   by James Z. M. Gao. <br>
...
!** FLOW
    ...
    ! perform hashing
    HashCode = NM_V2_Hash32(InpPtr, Seed)
...
!** FLOW
    ...
    ! perform hashing
    HashCode = NMx_V2_Hash32(InpPtr, Seed)
...
END FUNCTION NMx_Hash32_Opt

!******************************************************************************

FUNCTION NM_V2_Hash32(Input, Seed) RESULT(HashCode)
...
FUNCTION NMx_V2_Hash32(Input, Seed) RESULT(HashCode)
...
!** SUBROUTINE INTERNAL VARIABLE DECLARATIONS:
    ...
    tInteger    :: Sum
    tIndex      :: NbRounds, I, J, TwiceSizeOfACC
...
!** FLOW
    ...
    J = 0
    DO I = 0, NbRounds-1
        CALL NMHASH32_LongRound(AccX, AccY, P, J)
        J = J + TwiceSizeOfACC
    END DO
...
END SUBMODULE SubBase_NMHashV2_Opt
