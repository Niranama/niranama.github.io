...
! FLOW
    ...
    CALL L64X128RNG_SetParameters(RNG, Mix_Murmur(InitSeed), 1_kLong, Mix_Stafford_13(InitSeed), &
...
!** SUBROUTINE PARAMETER DECLARATIONS:
    ...
    tLong, PARAMETER    :: M = ToLong(Z'D1342543DE82EF95')
...
! FLOW
    ...
    IF (RNG%UseStarStar) THEN
        ...
        RandNum = RotateLeft((RNG%S + RNG%X0)*5_kLong, 7)*9_kLong   ! "starstar" scrambler
    ELSE
