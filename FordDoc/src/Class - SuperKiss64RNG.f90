...
!** MODULE PARAMETERS:
    ...
    tLong,  PARAMETER :: CMul  = 6906969069_kLong
    tLong,  PARAMETER :: CAdd  = 123_kLong
...
!** DERIVED TYPE DEFINITIONS
    ...
    TYPE, EXTENDS(LongRNG)  :: SuperKiss64RNG
        ...
        !% carry
        tLong       :: Carry = 36243678541_kLong
        !% state of the linear congruential generator
        tLong       :: CState = 12367890123456_kLong
        !% state of the xorshift generator
        tLong       :: XState = 521288629546311_kLong
    CONTAINS
        ! ---------------------------------------------------------------------
        ! -----                 Deferred Procedures                       -----
        ! ---------------------------------------------------------------------
...
CONTAINS
    ...
    !** SUBROUTINE ARGUMENT DECLARATIONS:
        tLong,  INTENT(INOUT)   :: Q(:) !! QState array
        tLong,  INTENT(INOUT)   :: C    !! Carry
        tIndex, INTENT(INOUT)   :: ID   !! Index
        tLong                   :: Q1   !! the first QState
...
END MODULE Class_SuperKiss64RNG
