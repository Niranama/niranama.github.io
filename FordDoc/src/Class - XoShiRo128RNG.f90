...
!** MODULE PARAMETERS:
    ...
    tInteger, PARAMETER :: JUMP_COEFFICIENTS(0:SEED_SIZE-1) = [ &
        ToInteger(Z'8764000B'), ToInteger(Z'F542D2D3'),         &
        ToInteger(Z'6FA035C3'), ToInteger(Z'77F2DB5B')]
    ! The coefficients for the long jump function
    tInteger, PARAMETER :: LONG_JUMP_COEFFICIENTS(0:SEED_SIZE-1) = [ &
        ToInteger(Z'B523952E'), ToInteger(Z'0B6F099F'),              &
        ToInteger(Z'CCF5A0EF'), ToInteger(Z'1C580662')]
    ! Parameters for algorithm flag
    tInteger, PARAMETER, PUBLIC :: XoShiRo128StarStar = 1   !! flag for XoShiRo128StarStar PRNG
    tInteger, PARAMETER, PUBLIC :: XoShiRo128Plus     = 2   !! flag for XoShiRo128Plus PRNG
    tInteger, PARAMETER, PUBLIC :: XoShiRo128PlusPlus = 3   !! flag for XoShiRo128PlusPlus PRNG
...
!** DERIVED TYPE DEFINITIONS
    ...
    TYPE, EXTENDS(IntegerRNG)  :: XoShiRo128RNG
        PRIVATE
        ! states
        tInteger    :: State0, State1, State2, State3
        ! algorithm flag
        tInteger    :: XoShiRoAlgo = XoShiRo128StarStar
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(XoShiRo128RNG), INTENT(INOUT) :: RNG          !! 'XoShiRo128RNG' object
    tInteger,             INTENT(IN)    :: JCoef(0:)    !! jump coefficients

!** SUBROUTINE INTERNAL VARIABLE DECLARATIONS:
    tInteger    :: S0, S1, S2, S3, I, B, Dummy
...
END MODULE Class_XoShiRo128RNG
