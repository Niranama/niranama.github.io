...
MODULE Class_DArrCmpxDP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *DArrCmpxDP* type and related routines.
!   The *DArrCmpxDP* type is a container with *COMPLEX(KIND=kDP)* as the type
...
#define TypeAlloc       COMPLEX(KIND=kDP), ALLOCATABLE
#define TypeArgmt       COMPLEX(KIND=kDP)
#define TypeOfItem      COMPLEX(KIND=kDP)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_DArrCmpxDP'
