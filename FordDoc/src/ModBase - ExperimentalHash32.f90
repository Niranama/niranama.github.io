...
MODULE ModBase_ExperimentalHash32
...
!   <a href="../module/modbase_referencehash32.html">ModBase_ReferenceHash32</a> module.
...
!   <br>
!^ **REFERENCES**: <br>
!   See the <a href="../module/modbase_referencehash32.html">ModBase_ReferenceHash32</a>
...
!** USE STATEMENTS:
    ...
    USE ModBase_Common
    USE ModBase_ByteUtil,   ONLY: SwapBytes
...
#define MaskI32(X)      IAND(ToInteger(X), ToInteger(Z'000000FF'))
#define MaskI16(X)      IAND(ToShort(X), ToShort(Z'00FF'))
...
!** INTERFACE DEFINITIONS:
    ABSTRACT INTERFACE
        FUNCTION Pack_I16(Buf, Off) RESULT(Res)
            !^ To convert an array of 8-bit integers starting at the offset to
            !  a 16-bit integer value.
            IMPORT
            tByte, TARGET, INTENT(IN)   :: Buf(0:)  !! byte array
...
!** SUBROUTINE INTERNAL VARIABLE DECLARATIONS:
    tInteger, POINTER   :: fPtr     ! Fortran pointer to the input
...
END MODULE ModBase_ExperimentalHash32
