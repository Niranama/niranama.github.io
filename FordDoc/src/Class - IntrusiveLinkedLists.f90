...
MODULE Class_IntrusiveLinkedLists
...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_IntrusiveLinkedLists'
...
!** DERIVED TYPE DEFINITIONS
    ...
    TYPE, ABSTRACT  :: DoublyLinkedNode
        PRIVATE
    ...
    !   See the <a href="../module/Class_IntrusiveLinkedLists.html#type-doublylinkednode">DoublyLinkedNode</a>
    ...
    !   <a href="../module/Class_IntrusiveLinkedLists.html#type-intrusivelinearlist">IntrusiveLinearList</a>
...
!** INTERFACE DEFINITIONS:
    ...
    ABSTRACT INTERFACE
        !> *EqualNodes* is an abstract procedure interface to check whether
        !  two objects in the *DoublyLinkedNode* class are equal to one another
        !  or not.  The output flag should be set to true if they are equal.
        !  Otherwise, the flag should be set to false.
        FUNCTION EqualNodes(A, B) RESULT(Flag)
            IMPORT
            CLASS(DoublyLinkedNode), INTENT(IN) :: A
            CLASS(DoublyLinkedNode), INTENT(IN) :: B
            tLogical                            :: Flag
        END FUNCTION
        !> *CompareNodes* is an abstract procedure interface to compare two
        !  objects in the *DoublyLinkedNode* class where the output flag
        !  should be set to the following value: <br>
        !   1 (or positive value) if A is greater than B, <br>
        !   0 if A is equal to B, <br>
        !  -1 (or negative value) if A is less than B.
        FUNCTION CompareNodes(A,B) RESULT(Flag)
            IMPORT
            CLASS(DoublyLinkedNode), INTENT(IN) :: A
            CLASS(DoublyLinkedNode), INTENT(IN) :: B
            tInteger                            :: Flag
...
END MODULE Class_IntrusiveLinkedLists
