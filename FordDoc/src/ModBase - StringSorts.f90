...
!** USE STATEMENTS:
    USE ModBase_Common
    USE ModBase_ChrStr,             ONLY: ChangeCase
    USE Class_Comparable
    USE Class_FvlStr
    USE Class_Alphabets,            ONLY: Alphabet => BaseAlphabet
#ifdef Indx64Bits
    USE ModBase_DoublyLinkedLists,  ONLY: StackInteger => ListInteger8B
#else
    USE ModBase_DoublyLinkedLists,  ONLY: StackInteger => ListInteger4B
#endif
...
!** INTERFACE DEFINITIONS:
    ...
    INTERFACE MSDInplaceSort
        ...
        !  **Usage**: See the <a href="../module/class_alphabets.html">Class_Alphabets</a>
...
END MODULE ModBase_StringSorts
