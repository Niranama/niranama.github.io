...
!   the inserted key.  <br>
!   Similar to the <a href="../module/class_multiwaytrie.html#type-multiwaytrie">
...
!   See the <a href="../module/class_alphabets.html">Class_Alphabets</a> module for
...
!** USE STATEMENTS:
    ...
    USE ModBase_DoublyLinkedLists,  ONLY: QueueString => ListCharacter, QueueAny => ListAnyType
    USE Class_FvlStr
    USE Class_StringBuilder
    USE Class_Alphabets,            ONLY: Alphabet => BaseAlphabet
