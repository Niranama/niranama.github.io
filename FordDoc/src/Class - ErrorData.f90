...
!** DERIVED TYPE DEFINITIONS
    ...
    TYPE ErrorData
        PRIVATE
        tInteger        :: Level = ErrNone      ! error level
        tInteger        :: Code  = 0            ! error code
...
!** SUBROUTINE ARGUMENT DEFINITIONS:
    ...
    tInteger,  OPTIONAL, INTENT(IN)     :: ErrCode      !! numerical code of the error
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tInteger,         INTENT(OUT)   :: ErrLevel     !! level of error
    tInteger,         INTENT(OUT)   :: ErrCode      !! numerical code of the error
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(ErrorData), INTENT(IN)    :: ErrFlag      !! the error data object
    tInteger                        :: ErrLevel     !! level of error
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(ErrorData), INTENT(IN)    :: ErrFlag  !! the error data object
    tInteger                        :: ErrCode  !! numerical code of the error
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(ErrorData),   INTENT(INOUT)   :: ErrFlag  !! the error data object
    tInteger, OPTIONAL, INTENT(INOUT)   :: OutUnit  !! the output unit number to report to
