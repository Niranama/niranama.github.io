...
MODULE Class_DArrInteger1B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *DArrInteger1B* type and related routines.
!   The *DArrInteger1B* type is a container with *INTEGER(KIND=kI1B)* as the type
...
#define TypeAlloc       INTEGER(KIND=kI1B), ALLOCATABLE
#define TypeArgmt       INTEGER(KIND=kI1B)
#define TypeOfItem      INTEGER(KIND=kI1B)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_DArrInteger1B'
...
END MODULE Class_DArrInteger1B
