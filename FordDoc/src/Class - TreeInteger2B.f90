...
!   type uses the Fortran intrinsic *INTEGER(KIND=kI2B)* type as the type of its stored keys
...
#define KeyTypeC        INTEGER(KIND=kI2B)
...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_TreeInteger2B'
...
END MODULE Class_TreeInteger2B
