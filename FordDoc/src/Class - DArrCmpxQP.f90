...
MODULE Class_DArrCmpxQP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *DArrCmpxQP* type and related routines.
!   The *DArrCmpxQP* type is a container with *COMPLEX(KIND=kQP)* as the type
...
#define TypeAlloc       COMPLEX(KIND=kQP), ALLOCATABLE
#define TypeArgmt       COMPLEX(KIND=kQP)
#define TypeOfItem      COMPLEX(KIND=kQP)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_DArrCmpxQP'
