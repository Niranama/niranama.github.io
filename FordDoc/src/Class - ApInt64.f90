...
!   types. <br>
!   See the <a href="../module/class_ApInt32.html">ApInt32</a> type for a **mutable,
...
!** MODULE PARAMETERS:
    ! name of the module
    tCharStar, PARAMETER    :: ModName = 'Class_ApInt64'
