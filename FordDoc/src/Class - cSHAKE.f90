...
!   the <a href="../module/class_kp1600core.html#type-kp1600core">
...
!   Like the <a href="../module/class_shake.html#type-shake">SHAKE</a>
...
!   See the <a href="../module/class_shake.html">Class_SHAKE</a> module for
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tByte,    PARAMETER :: NonEmptySuffix = ToByte(Z'04')
    tByte,    PARAMETER :: EmptySuffix    = ToByte(Z'1F')
...
! FLOW
    ...
    DO I = 1, N
        EncBuf(I) = ToByte(SHIFTR(Value, 8*(N-I)))
    END DO
    EncBuf(0) = ToByte(N)
    N = N + 1
