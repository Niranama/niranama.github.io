...
MODULE ModBase_BytePack

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains utility routines for conversion of bit patterns between
!   a byte (an array of 8-bit integers) array and other integer types.  The module
...
#define MaskInteger(X)      IAND(ToInteger(X), ToInteger(Z'000000FF'))
#define MaskLong(X)         IAND(ToLong(X),    ToLong(Z'00000000000000FF'))
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tByte,          INTENT(IN)  :: ByteArr(Bytes_kShort)    !! byte array
...
! FLOW
    ...
    CALL C_F_POINTER(cPtr, fPtr, [Bytes_kShort])
...
! FLOW
    ...
    MinBytes = MIN(SIZE(ByteArr)/Bytes_kShort , SIZE(I16Arr))*Bytes_kShort
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tByte,            INTENT(IN)    :: ByteArr(Bytes_kInteger)  !! byte array
...
! FLOW
    ...
    ! associate a Fortran pointer with the C pointer
    CALL C_F_POINTER(cPtr, fPtr, [Bytes_kInteger])
...
! FLOW
    ...
    ! get minimum byte sizes
    MinBytes = MIN(SIZE(ByteArr)/Bytes_kInteger , SIZE(I32Arr))*Bytes_kInteger
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tByte,         INTENT(IN)   :: ByteArr(Bytes_kLong) !! byte array
...
! FLOW
    ...
    ! associate a Fortran pointer with the C pointer
    CALL C_F_POINTER(cPtr, fPtr, [Bytes_kLong])
...
! FLOW
    ...
    ! get minimum byte sizes
    MinBytes = MIN(SIZE(ByteArr)/Bytes_kLong , SIZE(I64Arr))*Bytes_kLong
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tByte,          INTENT(OUT)  :: ByteArr(Bytes_kShort)    !! byte array
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tByte,            INTENT(OUT)   :: ByteArr(Bytes_kInteger)  !! byte array
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tByte,         INTENT(OUT)  :: ByteArr(Bytes_kLong) !! byte array
...
!    I16 = ToShort(UnsignedShort(ByteArr, 1))
!#undef Byte2Integer
!#undef UnsignedByte
!#undef UnsignedShort
...
!    I16 = TRANSFER([ByteArr(2), ByteArr(1)], 0_kShort)
...
!** SUBROUTINE INTERNAL VARIABLE DECLARATIONS:
    tInteger    :: MinSize, Offset, I
    

! FLOW
    
    ! get minimum size
    MinSize = MIN(SIZE(ByteArr)/Bytes_kShort , SIZE(I16Arr))
...
!    END DO
    ...
    ! implementation algorithm #5 (slowest)
!    I32 = TRANSFER([ByteArr(4), ByteArr(3), ByteArr(2), ByteArr(1)], 0_kInteger)
...
! FLOW
    ...
    ! get minimum sizes
    MinSize = MIN(SIZE(ByteArr)/Bytes_kInteger , SIZE(I32Arr))
...
!                   ByteArr(4), ByteArr(3), ByteArr(2), ByteArr(1)], 0_kLong)
...
! FLOW
    ...
    ! get minimum sizes
    MinSize = MIN(SIZE(ByteArr)/Bytes_kLong , SIZE(I64Arr))
...
! FLOW
    ...
    ! implementation algorithm #1
    ByteArr(1) = ToByte(SHIFTR(I16, 8))
    ByteArr(2) = ToByte(I16)

    ! implementation algorithm #2 (comparable to #1)
!    ByteArr(1) = ToByte(IBITS(I16, 8, 8))
!    ByteArr(2) = ToByte(IBITS(I16, 0, 8))
...
! FLOW
    ...
    ! implementation algorithm #1
    ByteArr(1) = ToByte(SHIFTR(I32, 24))
    ByteArr(2) = ToByte(SHIFTR(I32, 16))
    ByteArr(3) = ToByte(SHIFTR(I32, 8))
    ByteArr(4) = ToByte(I32)

    ! implementation algorithm #2 (comparable to #1)
!    ByteArr(1) = ToByte(IBITS(I32, 24, 8))
!    ByteArr(2) = ToByte(IBITS(I32, 16, 8))
!    ByteArr(3) = ToByte(IBITS(I32,  8, 8))
!    ByteArr(4) = ToByte(IBITS(I32,  0, 8))
...
! FLOW
    ...
    ! implementation algorithm #1
    ByteArr(1) = ToByte(SHIFTR(I64, 56))
    ByteArr(2) = ToByte(SHIFTR(I64, 48))
    ByteArr(3) = ToByte(SHIFTR(I64, 40))
    ByteArr(4) = ToByte(SHIFTR(I64, 32))
    ByteArr(5) = ToByte(SHIFTR(I64, 24))
    ByteArr(6) = ToByte(SHIFTR(I64, 16))
    ByteArr(7) = ToByte(SHIFTR(I64, 8))
    ByteArr(8) = ToByte(I64)

    ! implementation algorithm #2 (comparable to #1)
!    ByteArr(1) = ToByte(IBITS(I64, 56, 8))
!    ByteArr(2) = ToByte(IBITS(I64, 48, 8))
!    ByteArr(3) = ToByte(IBITS(I64, 40, 8))
!    ByteArr(4) = ToByte(IBITS(I64, 32, 8))
!    ByteArr(5) = ToByte(IBITS(I64, 24, 8))
!    ByteArr(6) = ToByte(IBITS(I64, 16, 8))
!    ByteArr(7) = ToByte(IBITS(I64,  8, 8))
!    ByteArr(8) = ToByte(IBITS(I64,  0, 8))
...
!    CALL MVBITS(MaskShort(ByteArr(2)), 0, 8, I16, 8)
    ...
    ! implementation algorithm #5 (slowest)
!    I16 = TRANSFER([ByteArr(1), ByteArr(2)], 0_kShort)
...
!          SHIFTL(MaskInteger(ByteArr(4)), 24)
    ...
    ! implementation algorithm #3 (comparable to #1)
!#define Byte2Integer(Val, Off)  ToInteger(Val(Off))
!#define UnsignedByte(Val, Off)  IAND(Byte2Integer(Val, Off), ToInteger(Z'000000FF'))
!#define UnsignedShort(Val, Off) IOR(UnsignedByte(Val, Off), SHIFTL(UnsignedByte(Val, Off+1), 8))
...
!    END DO
    ...
    ! implementation algorithm #5 (slowest)
!    I32 = TRANSFER([ByteArr(1), ByteArr(2), ByteArr(3), ByteArr(4)], 0_kInteger)
...
!                   ByteArr(5), ByteArr(6), ByteArr(7), ByteArr(8)], 0_kLong)
...
! FLOW
    ...
    ! implementation algorithm #1
    ByteArr(1) = ToByte(I16)
    ByteArr(2) = ToByte(SHIFTR(I16, 8))

    ! implementation algorithm #2 (comparable to #1)
!    ByteArr(1) = ToByte(IBITS(I16, 0, 8))
!    ByteArr(2) = ToByte(IBITS(I16, 8, 8))
...
! FLOW
    ...
    ! implementation algorithm #1
    ByteArr(1) = ToByte(I32)
    ByteArr(2) = ToByte(SHIFTR(I32, 8))
    ByteArr(3) = ToByte(SHIFTR(I32, 16))
    ByteArr(4) = ToByte(SHIFTR(I32, 24))

    ! implementation algorithm #2 (comparable to #1)
!    ByteArr(1) = ToByte(IBITS(I32,  0, 8))
!    ByteArr(2) = ToByte(IBITS(I32,  8, 8))
!    ByteArr(3) = ToByte(IBITS(I32, 16, 8))
!    ByteArr(4) = ToByte(IBITS(I32, 24, 8))
...
! FLOW
    ...
    ! implementation algorithm #1
    ByteArr(1) = ToByte(I64)
    ByteArr(2) = ToByte(SHIFTR(I64, 8))
    ByteArr(3) = ToByte(SHIFTR(I64, 16))
    ByteArr(4) = ToByte(SHIFTR(I64, 24))
    ByteArr(5) = ToByte(SHIFTR(I64, 32))
    ByteArr(6) = ToByte(SHIFTR(I64, 40))
    ByteArr(7) = ToByte(SHIFTR(I64, 48))
    ByteArr(8) = ToByte(SHIFTR(I64, 56))

    ! implementation algorithm #2 (comparable to #1)
!    ByteArr(1) = ToByte(IBITS(I64,  0, 8))
!    ByteArr(2) = ToByte(IBITS(I64,  8, 8))
!    ByteArr(3) = ToByte(IBITS(I64, 16, 8))
!    ByteArr(4) = ToByte(IBITS(I64, 24, 8))
!    ByteArr(5) = ToByte(IBITS(I64, 32, 8))
!    ByteArr(6) = ToByte(IBITS(I64, 40, 8))
!    ByteArr(7) = ToByte(IBITS(I64, 48, 8))
!    ByteArr(8) = ToByte(IBITS(I64, 56, 8))
