...
!   use the <a href="../module/modbase_sint128.html#type-sint128">SInt128</a> type instead
!   for efficiency reason.  Likewise, if a number is always in a range provided by
!   a 128-bit unsigned integer, the <a href="../module/modbase_uint128.html#type-uint128">
!   UInt128</a> type can be used with better performance. <br>
...
!   types. <br>
!   See the <a href="../module/class_apint64.html">ApInt64</a> type for a **mutable,
...
!   [2] <a href="https://docs.oracle.com/en%2Fjava%2Fjavase%2F11%2Fdocs%2Fapi%2F%2F/java.base/java/math/BigInteger.html">
...
!** MODULE PARAMETERS:
    ! name of the module
    tCharStar, PARAMETER    :: ModName = 'Class_ApInt32'
    ! Used to cast a 32-bit integer to a 64-bit integer without getting unwanted sign extension
    tLong,     PARAMETER    :: MASK = ToLong(Z'00000000FFFFFFFF')  ! SHIFTL(1_kLong, 32) - 1_kLong
...
!** GENERIC DEFINITIONS:
    ...
    INTERFACE  ToI32
        ...
        MODULE FUNCTION I32_From_ApInt32(Big) RESULT(I32)
            ...
            TYPE(ApInt32), INTENT(IN)   :: Big
            tInteger                    :: I32  !! a 32-bit integer treated as signed
    ...
    INTERFACE  ToI64
        ...
        MODULE FUNCTION I64_From_ApInt32(Big) RESULT(I64)
            ...
            TYPE(ApInt32), INTENT(IN)   :: Big
            tLong                       :: I64  !! a 64-bit integer treated as signed
