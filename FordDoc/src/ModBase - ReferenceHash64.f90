...
MODULE ModBase_ReferenceHash64
...
!   <a href="../module/modbase_simplehash64.html">ModBase_SimpleHash64</a> module.
!   The main difference between routines in these two modules is that routines in
!   the *ModBase_SimpleHash64* module process input data one byte at a time whereas
...
END MODULE ModBase_ReferenceHash64
