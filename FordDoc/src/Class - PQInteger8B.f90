...
MODULE Class_PQInteger8B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *PQInteger8B* type and its related routines.
!   The *PQInteger8B* type is a priority-queue container with *INTEGER(KIND=kI8B)*
...
#define     KeyType     INTEGER(KIND=kI8B)
#define     PQHeap      PQInteger8B

!** MODULE PARAMETERS:
    tCharStar, PARAMETER    :: ModName = 'Class_PQInteger8B'
