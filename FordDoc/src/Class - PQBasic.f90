...
!   any sorting algorithm from the *ModBase_SortAscend* and *ModBase_SortDescend*
...
!   See the <a href="../module/class_pqheap.html">Class_PQHeap</a> module for more
...
!   See the <a href="../module/modbase_sortdescend.html">ModBase_SortDescend</a> module
!   for routines that perform sorting of an array in a *descending* order, and see the
!   <a href="../module/modbase_sortascend.html">ModBase_SortAscend</a> module for routines
!   that perform sorting of an array in an *ascending* order.
...
!** USE STATEMENTS:
    ...
    USE ModBase_SortAscend,     ONLY: RustSortAscend  => RustSort
    USE ModBase_SortDescend,    ONLY: RustSortDescend => RustSort
...
!** MODULE PARAMETERS:
    tCharStar, PARAMETER    :: ModName = 'Class_PQBasic'
