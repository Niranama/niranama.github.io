...
MODULE Class_ListCmpxSP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *ListCmpxSP* type and related routines.
!   The *ListCmpxSP* type is a container with *COMPLEX(KIND=kSP)* as the type
...
#define ItemTypeA           COMPLEX(KIND=kSP)
#define ItemTypeB           COMPLEX(KIND=kSP)
#define ItemTypeC           COMPLEX(KIND=kSP)
#define TypeOfItem          COMPLEX(KIND=kSP)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_ListCmpxSP'
