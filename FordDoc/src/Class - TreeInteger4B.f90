...
!   type uses the Fortran intrinsic *INTEGER(KIND=kI4B)* type as the type of its stored keys
...
#define KeyTypeC        INTEGER(KIND=kI4B)
...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_TreeInteger4B'
...
END MODULE Class_TreeInteger4B
