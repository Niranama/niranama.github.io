...
!** USE STATEMENTS:
    USE ModBase_Common
    USE ModBase_UIntUtil,   ONLY: U128_Multiply => UMul128
    USE Class_BaseRNG
    USE Class_LongRNG
...
!    tLong, PARAMETER    :: M = ToLong(Z'A0761D6478BD642F')
!    tLong, PARAMETER    :: N = ToLong(Z'E7037ED1A0B428DB')
    ! M and N parameters for "wyhash_final_version_4_2"
    tLong, PARAMETER    :: M = ToLong(Z'2D358DCCAA6C78A5')
    tLong, PARAMETER    :: N = ToLong(Z'8BB84B93962EACC9')
...
!** DERIVED TYPE DEFINITIONS
    ...
    TYPE, EXTENDS(LongRNG)  :: WyRNG
        PRIVATE
        ! tLong       :: State1 = ToLong(Z'8EBC6AF09C88C6E3')
        ! tLong       :: State2 = ToLong(Z'589965CC75374CC')
        tLong       :: State1 = ToLong(Z'4B33A62ED433D4A3')
        tLong       :: State2 = ToLong(Z'4D5A2DA51DE1AA47')
        tInteger    :: Counter = 0
    CONTAINS
        ! ---------------------------------------------------------------------
        ! -----                 Deferred Procedures                       -----
