...
!** MODULE PARAMETERS:
    ...
    tInteger, PARAMETER :: CMul  = 69609_kInteger
    tInteger, PARAMETER :: CAdd  = 123_kInteger
...
!** DERIVED TYPE DEFINITIONS
    ...
    TYPE, EXTENDS(IntegerRNG)  :: SuperKiss32RNG
        ...
        tInteger    :: QState(QSIZE)
        !% index into QState
        tIndex      :: Index = QSIZE + 1_kIndex
        !% carry
        tInteger    :: Carry = 362_kInteger
        !% state of the linear congruential generator
        tInteger    :: CState = 1236789_kInteger
        !% state of the xorshift generator
        tInteger    :: XState = 521288629_kInteger
    CONTAINS
        ! ---------------------------------------------------------------------
        ! -----                 Deferred Procedures                       -----
        ! ---------------------------------------------------------------------
...
CONTAINS
    ...
    !** SUBROUTINE ARGUMENT DECLARATIONS:
        tInteger, INTENT(INOUT) :: Q(:) !! QState array
        tInteger, INTENT(INOUT) :: C    !! Carry
        tIndex,   INTENT(INOUT) :: ID   !! Index
        tInteger                :: Q1   !! the first QState
...
END MODULE Class_SuperKiss32RNG
