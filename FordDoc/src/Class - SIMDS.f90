...
!** MODULE PARAMETERS:
    ...
    tInteger, PARAMETER :: IV224(0:15) = [              &
        ToInteger(Z'33586E9F'), ToInteger(Z'12FFF033'), &
        ToInteger(Z'B2D9F64D'), ToInteger(Z'6F8FEA53'), &
        ToInteger(Z'DE943106'), ToInteger(Z'2742E439'), &
        ToInteger(Z'4FBAB5AC'), ToInteger(Z'62B9FF96'), &
        ToInteger(Z'22E7B0AF'), ToInteger(Z'C862B3A8'), &
        ToInteger(Z'33E00CDC'), ToInteger(Z'236B86A6'), &
        ToInteger(Z'F64AE77C'), ToInteger(Z'FA373B76'), &
        ToInteger(Z'7DC1EE5B'), ToInteger(Z'7FB29CE8')]
    tInteger, PARAMETER :: IV256(0:15) = [              &
        ToInteger(Z'4D567983'), ToInteger(Z'07190BA9'), &
        ToInteger(Z'8474577B'), ToInteger(Z'39D726E9'), &
        ToInteger(Z'AAF3D925'), ToInteger(Z'3EE20B03'), &
        ToInteger(Z'AFD5E751'), ToInteger(Z'C96006D3'), &
        ToInteger(Z'C2C2BA14'), ToInteger(Z'49B3BCB4'), &
        ToInteger(Z'F67CAF46'), ToInteger(Z'668626C9'), &
        ToInteger(Z'E2EAA8D2'), ToInteger(Z'1FF47833'), &
        ToInteger(Z'D0C661A5'), ToInteger(Z'55693DE1')]
    tInteger, PARAMETER, PUBLIC :: MaskI8  = ToInteger(Z'000000FF')
    tInteger, PARAMETER, PUBLIC :: MaskI16 = ToInteger(Z'0000FFFF')
...
! FLOW
    ...
    ASSOCIATE(TmpBuf => MD%BufArr)
        ...
        BlockCount = SHIFTL(MD%GetBlockCount(), 9) + ToLong(SHIFTL(Ptr, 3)) + ToLong(NBits)
