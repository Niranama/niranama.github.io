...
!** MODULE PARAMETERS:
    ...
    tInteger, PARAMETER :: SEED_SIZE  = 5
    tInteger, PARAMETER :: STATE_SIZE = 16
...
!** SUBROUTINE PARAMETER DECLARATIONS:
    ...
    tInteger, PARAMETER :: Primes(4) = [ToInteger(Z'FA835867'), &
                                        ToInteger(Z'2086CA69'), &
                                        ToInteger(Z'1467C0FB'), &
                                        ToInteger(Z'638E2B99')]

!** SUBROUTINE INTERNAL VARIABLE DECLARATIONS:
    tLong       :: Seed0(SEED_SIZE)
    tUInt32     :: Key(8), IV(2)
    tIndex      :: I, J
...
!** FLOW
    ...
    IF (RNG%Input(13) == 0_kInteger) THEN
