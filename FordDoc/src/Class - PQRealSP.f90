...
MODULE Class_PQRealSP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *PQRealSP* type and its related routines.
!   The *PQRealSP* type is a priority-queue container with *REAL(KIND=kSP)*
...
#define     KeyType     REAL(KIND=kSP)
#define     PQHeap      PQRealSP

!** MODULE PARAMETERS:
    tCharStar, PARAMETER    :: ModName = 'Class_PQRealSP'
