...
#define ItemTypeA           INTEGER(KIND=kI4B)
#define ItemTypeB           INTEGER(KIND=kI4B)
#define ItemTypeC           INTEGER(KIND=kI4B)
#define TypeOfItem          INTEGER(KIND=kI4B)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_ListInteger4B'
...
END MODULE Class_ListInteger4B
