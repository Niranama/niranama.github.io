...
MODULE ModBase_PrgnBuilder
       
!^ **PURPOSE OF THIS MODULE**: <br>
!   This module provides access to random number generator classes
!   and two groups of general routines that perform the following tasks: <br>
!   - Construct a random number class based on the specified algorithm. <br>
...
!** USE STATEMENTS:
    ...
    USE Class_LongRNG
    ! integer classes
    USE Class_Cmwc4096RNG
    USE Class_IsaccRNG
    USE Class_Jsf32RNG
    USE Class_Kiss32RNG
    USE Class_L32X64MRNG
    USE Class_L32X64RNG
    USE Class_Lfsr113RNG
    USE Class_Mrg32k3aRNG
    USE Class_Mt32RNG
    USE Class_Mwc256RNG
    USE Class_PcgLcg32RNG
    USE Class_PcgMcg32RNG
    USE Class_RanLuxRNG
    USE Class_Sfc32RNG
    USE Class_SuperKiss32RNG
    USE Class_Taus88RNG
    USE Class_Well32RNG
    USE Class_XoRoShiRo64RNG
    USE Class_XoShiRo128RNG
    ! long classes
    USE Class_ChaChaRNG
    USE Class_Jsf64RNG
    USE Class_Kiss64RNG
    USE Class_KomiRNG
    USE Class_L64X128RNG
    USE Class_L64X256RNG
    USE Class_L64X1024RNG
    USE Class_L64XMRNG
    USE Class_L128X128RNG
    USE Class_L128X256RNG
    USE Class_L128X1024RNG
    USE Class_L128XMRNG
    USE Class_Lfsr258RNG
    USE Class_Mrg63k3aRNG
    USE Class_MswsRNG
    USE Class_Mt64RNG
    USE Class_PcgRxsMXs64RNG
    USE Class_RanLuxPpRNG
    USE Class_Sfc64RNG
    USE Class_Sip24RNG
    USE Class_SplitMixRNG
    USE Class_SuperKiss64RNG
    USE Class_WyRNG
    USE Class_XoRoShiRo128RNG
    USE Class_XoRoShiRo1024RNG
    USE Class_XoShiRo256RNG
    USE Class_XoShiRo512RNG
...
#define     PublicParam     tInteger, PARAMETER, PUBLIC 

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'ModBase_PrgnBuilder'
    ! -------------------------------------------------------------------------
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger,           INTENT(IN)  :: RngAlgo  !! flag indicating algorithm (1-29)
    tInteger, OPTIONAL, INTENT(IN)  :: Seed(:)  !! seed(s)
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger,        INTENT(IN)     :: RngAlgo  !! flag indicating algorithm (1-41)
    tLong, OPTIONAL, INTENT(IN)     :: Seed(:)  !! seed(s)
    CLASS(BaseRNG),  ALLOCATABLE    :: NewRng   !! 'BaseRNG' object
...
END MODULE ModBase_PrgnBuilder
