...
!** SUBROUTINE INTERNAL PARAMETER DECLARATIONS:
    tInteger, PARAMETER :: K1   = ToInteger(Z'5A827999')
    tInteger, PARAMETER :: K2   = ToInteger(Z'6ED9EBA1')
    tInteger, PARAMETER :: K3   = ToInteger(Z'8F1BBCDC')
    tInteger, PARAMETER :: K4   = ToInteger(Z'CA62C1D6')
