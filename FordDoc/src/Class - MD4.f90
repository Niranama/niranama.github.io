...
! FLOW
    ...
    A = RotateLeft(A + GRound(B, C, D) + X( 0) + ToInteger(Z'5A827999'), 3)
    D = RotateLeft(D + GRound(A, B, C) + X( 4) + ToInteger(Z'5A827999'), 5)
    C = RotateLeft(C + GRound(D, A, B) + X( 8) + ToInteger(Z'5A827999'), 9)
    B = RotateLeft(B + GRound(C, D, A) + X(12) + ToInteger(Z'5A827999'), 13)
    A = RotateLeft(A + GRound(B, C, D) + X( 1) + ToInteger(Z'5A827999'), 3)
    D = RotateLeft(D + GRound(A, B, C) + X( 5) + ToInteger(Z'5A827999'), 5)
    C = RotateLeft(C + GRound(D, A, B) + X( 9) + ToInteger(Z'5A827999'), 9)
    B = RotateLeft(B + GRound(C, D, A) + X(13) + ToInteger(Z'5A827999'), 13)
    A = RotateLeft(A + GRound(B, C, D) + X( 2) + ToInteger(Z'5A827999'), 3)
    D = RotateLeft(D + GRound(A, B, C) + X( 6) + ToInteger(Z'5A827999'), 5)
    C = RotateLeft(C + GRound(D, A, B) + X(10) + ToInteger(Z'5A827999'), 9)
    B = RotateLeft(B + GRound(C, D, A) + X(14) + ToInteger(Z'5A827999'), 13)
    A = RotateLeft(A + GRound(B, C, D) + X( 3) + ToInteger(Z'5A827999'), 3)
    D = RotateLeft(D + GRound(A, B, C) + X( 7) + ToInteger(Z'5A827999'), 5)
    C = RotateLeft(C + GRound(D, A, B) + X(11) + ToInteger(Z'5A827999'), 9)
    B = RotateLeft(B + GRound(C, D, A) + X(15) + ToInteger(Z'5A827999'), 13)
        
    A = RotateLeft(A + HRound(B, C, D) + X( 0) + ToInteger(Z'6ED9EBA1'), 3)
    D = RotateLeft(D + HRound(A, B, C) + X( 8) + ToInteger(Z'6ED9EBA1'), 9)
    C = RotateLeft(C + HRound(D, A, B) + X( 4) + ToInteger(Z'6ED9EBA1'), 11)
    B = RotateLeft(B + HRound(C, D, A) + X(12) + ToInteger(Z'6ED9EBA1'), 15)
    A = RotateLeft(A + HRound(B, C, D) + X( 2) + ToInteger(Z'6ED9EBA1'), 3)
    D = RotateLeft(D + HRound(A, B, C) + X(10) + ToInteger(Z'6ED9EBA1'), 9)
    C = RotateLeft(C + HRound(D, A, B) + X( 6) + ToInteger(Z'6ED9EBA1'), 11)
    B = RotateLeft(B + HRound(C, D, A) + X(14) + ToInteger(Z'6ED9EBA1'), 15)
    A = RotateLeft(A + HRound(B, C, D) + X( 1) + ToInteger(Z'6ED9EBA1'), 3)
    D = RotateLeft(D + HRound(A, B, C) + X( 9) + ToInteger(Z'6ED9EBA1'), 9)
    C = RotateLeft(C + HRound(D, A, B) + X( 5) + ToInteger(Z'6ED9EBA1'), 11)
    B = RotateLeft(B + HRound(C, D, A) + X(13) + ToInteger(Z'6ED9EBA1'), 15)
    A = RotateLeft(A + HRound(B, C, D) + X( 3) + ToInteger(Z'6ED9EBA1'), 3)
    D = RotateLeft(D + HRound(A, B, C) + X(11) + ToInteger(Z'6ED9EBA1'), 9)
    C = RotateLeft(C + HRound(D, A, B) + X( 7) + ToInteger(Z'6ED9EBA1'), 11)
    B = RotateLeft(B + HRound(C, D, A) + X(15) + ToInteger(Z'6ED9EBA1'), 15)  
