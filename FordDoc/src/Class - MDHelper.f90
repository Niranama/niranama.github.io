...
!** USE STATEMENTS:
    ...
    USE ModBase_BytePack,           ONLY: ByteUnpackBE, ByteUnpackLE
    USE Class_MDEngine
...
!** MODULE PARAMETERS:
    tCharStar, PARAMETER    :: ModName = 'Class_MDHelper'
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tByte, OPTIONAL, INTENT(IN)     :: FByte        !! the first padding byte
...
! FLOW
    ...
    CurrLen = MDH%GetBlockCount()*ToLong(BlockLen)
    CurrLen = (CurrLen + ToLong(DataLen))*8_kLong
    LenLen = MDH%LenLen
    CountBuf = 0_kByte
