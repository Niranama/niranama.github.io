...
!   *INTEGER(KIND=kI2B)* type as the type of its stored keys and an unlimited polymorphic type
...
#define     KeyTypeA        INTEGER(KIND=kI2B)
#define     KeyTypeB        INTEGER(KIND=kI2B)
...
END MODULE Class_HTabInteger2B
