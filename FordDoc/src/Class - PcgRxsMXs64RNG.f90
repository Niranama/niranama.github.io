...
! FLOW
    ...
    RNG%Increment = IOR(SHIFTL(Seed0(2), 1), 1_kLong)
...
! FLOW
    ...
    Word = IEOR(SHIFTR(X, (SHIFTR(X, 59) + 5)), X) * (-5840758589994634535_kLong)
...
!******************************************************************************
END MODULE Class_PcgRxsMXs64RNG
