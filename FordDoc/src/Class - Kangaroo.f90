...
!   <a href="../module/class_kp1600sponge.html#type-kp1600sponge">
...
!   not extends from the <a href="../module/class_kp1600core.html#type-kp1600core">
!   KP1600Core</a> type, due to different designs of internal structures. <br>
!   Similar to the <a href="../module/class_shake.html#type-shake">SHAKE</a>
...
!** MODULE PARAMETERS:
    ...
    tByte,    PARAMETER :: SuffixLeaf = ToByte(Z'0B')  ! '110': message hop, simple padding, inner node
...
! FLOW
    ...
    DO I = 1, N
        EncBuf(I-1) = ToByte(SHIFTR(Value, 8*(N-I)))
    END DO
    EncBuf(N) = ToByte(N)
    N = N + 1
