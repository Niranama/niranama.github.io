...
MODULE Class_DArrAssignable

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *DArrAssignable* type and related routines.
!   The *DArrAssignable* type is a container with *CLASS(Assignable)* as the type
...
!   *Assignable* type can be used with this container. <br>
!   Unlike the <a href="../module/class_listassignable.html">ListAssignable</a> type,
!   the *DArrAssignable* type does not allow items with different types to be stored
!   in the same container.  The *DArrAssignable* type requires a user to specify the
...
!   employed by the *DArrAssignable* type. <br>
...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_DArrAssignable'
...
!** DERIVED TYPE DEFINITIONS:
    !> *DArrAssignable* is a container type that employs a dynamic-array implementation
    ...
    !  *Assignable* class (i.e. the *Assignable* type or its subtypes).
    TYPE DArrAssignable
        PRIVATE
        ...
        CLASS(Assignable), ALLOCATABLE   :: Items(:)
    CONTAINS
        ! ---------------------------------------------------------------------
        ! -----             PRIVATE PROCEDURES                            -----
        ! ---------------------------------------------------------------------
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(DArrAssignable), INTENT(INOUT)    :: Container    !! DynArr object
...
!** SUBROUTINE INTERNAL VARIABLE DECLARATIONS:
    ...
    CLASS(Assignable), ALLOCATABLE   :: Temp(:)  ! temporary buffer
...
!** FLOW:
    ...
    CALL MemAlloc(Temp, NewSize, Container%Items(1))
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(DArrAssignable), INTENT(INOUT)    :: Container
    tIndex                                  :: First
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    !% DynArr object
    CLASS(DArrAssignable), INTENT(IN)   :: Container
    !% the specified index
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    CLASS(Assignable),     INTENT(IN)       :: Mold         !! mold providing the type of items to be stored
...
! FLOW
    ...
    CALL MemAlloc(Container%Items, Capacity, Mold)
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    CLASS(Assignable),     INTENT(IN)       :: Items(:)     !! the items to be added to the container
    tIndex,   OPTIONAL,    INTENT(IN)       :: IncSize      !! incremental size of the container when it is full
    tLogical, OPTIONAL,    INTENT(IN)       :: Shrink
    !^ flag to shrink the container capacity <br>
    ! - true if want to reduce capacity when the size is less than a quarter of the capacity. <br>
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    CLASS(Assignable),     INTENT(INOUT)    :: Item
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    CLASS(DArrAssignable),          INTENT(INOUT)   :: Container
    !% the item to be removed from the container
    CLASS(Assignable), ALLOCATABLE, INTENT(OUT)     :: Items(:)
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    CLASS(Assignable), OPTIONAL, INTENT(INOUT)  :: Item
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(DArrAssignable), INTENT(IN)   :: Container    !! DynArr object
...
! FLOW
    ...
    CALL MemAlloc(Items, N, Container%Items(1))
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    TYPE(DArrAssignable), INTENT(INOUT) :: Container    !! DynArr object
...
END MODULE Class_DArrAssignable
