...
MODULE Class_ListCmpxDP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *ListCmpxDP* type and related routines.
!   The *ListCmpxDP* type is a container with *COMPLEX(KIND=kDP)* as the type
...
#define ItemTypeA           COMPLEX(KIND=kDP)
#define ItemTypeB           COMPLEX(KIND=kDP)
#define ItemTypeC           COMPLEX(KIND=kDP)
#define TypeOfItem          COMPLEX(KIND=kDP)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_ListCmpxDP'
