...
PRIVATE &
  ...
  MP_MAX, MP_MIN, MP_MOD, MP_MTOR, MP_NRT, MP_PI, MP_PRODD, MP_PRODQ, &
  MP_QTOR, MP_QTOR2, MP_QUOTD, MP_QUOTQ, MP_RAND, MP_READR1, MP_READR2, &
