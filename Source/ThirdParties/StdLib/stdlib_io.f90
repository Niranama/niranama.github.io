...
contains
    ...
    subroutine  loadtxt_rxdp(filename, d, skiprows, max_rows, fmt)
      !! version: experimental
      !!
      !! Loads a 2D array from a text file.
      !!
    ...
    subroutine  loadtxt_rqp(filename, d, skiprows, max_rows, fmt)
      !! version: experimental
      !!
      !! Loads a 2D array from a text file.
      !!
    ...
    subroutine  loadtxt_cxdp(filename, d, skiprows, max_rows, fmt)
      !! version: experimental
      !!
      !! Loads a 2D array from a text file.
      !!
    ...
    subroutine  loadtxt_cqp(filename, d, skiprows, max_rows, fmt)
      !! version: experimental
      !!
      !! Loads a 2D array from a text file.
      !!
    ...
    subroutine savetxt_rxdp(filename, d)
      ...
      s = open(filename, "w")
      do i = 1, size(d, 1)
          write(s, "(*"//FMT_REAL_xdp(1:len(FMT_REAL_xdp)-1)//",1x))") d(i, :)
      end do
      close(s)
    ...
    subroutine savetxt_cxdp(filename, d)
      ...
      s = open(filename, "w")
      do i = 1, size(d, 1)
          write(s, "(*"//FMT_COMPLEX_xdp(1:len(FMT_COMPLEX_xdp)-1)//",1x))") d(i, :)
      end do
      close(s)
