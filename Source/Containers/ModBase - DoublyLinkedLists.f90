...
MODULE ModBase_DoublyLinkedLists
...
!   the *Assignable* class (i.e. the *Assignable* type or its subtypes). <br>
!   Available container types are: <br>
!   - the <a href="../module/class_listcharacter.html#type-listcharacter">ListCharacter</a> type
!     for character string type, <br>
!   - the <a href="../module/class_listcmpxsp.html#type-listcmpxsp">ListCmpxSP</a> type
!     for single-precision complex type, <br>
!   - the <a href="../module/class_listcmpxdp.html#type-listcmpxdp">ListCmpxDP</a> type
!     for double-precision complex type, <br>
!   - the <a href="../module/class_listcmpxqp.html#type-listcmpxqp">ListCmpxQP</a> type
!     for quadruple-precision complex type, <br>
!   - the <a href="../module/class_listinteger1b.html#type-listinteger1b">ListInteger1B</a> type
!     for 1-byte (or 8-bit) integer type, <br>
!   - the <a href="../module/class_listinteger2b.html#type-listinteger2b">ListInteger2B</a> type
!     for 2-byte (or 16-bit) integer type, <br>
!   - the <a href="../module/class_listinteger4b.html#type-listinteger4b">ListInteger4B</a> type
!     for 4-byte (or 32-bit) integer type, <br>
!   - the <a href="../module/class_listinteger8b.html#type-listinteger8b">ListInteger8B</a> type
!     for 8-byte (or 64-bit) integer type, <br>
!   - the <a href="../module/class_listlogical.html#type-listlogical">ListLogical</a> type
!     for default logical type, <br>
!   - the <a href="../module/class_listrealsp.html#type-listrealsp">ListRealSP</a> type
!     for single-precision real type, <br>
!   - the <a href="../module/class_listrealdp.html#type-listrealdp">ListRealDP</a> type
!     for double-precision real type, <br>
!   - the <a href="../module/class_listrealqp.html#type-listrealqp">ListRealQP</a> type
!     for quadruple-precision real type, and <br>
!   - the <a href="../module/class_listassignable.html#type-listassignable">ListAssignable</a> type
!     for a derived type in the *Assignable* class, and <br>
!   - the <a href="../module/class_listanytype.html#type-listanytype">ListAnyType</a> type
...
!   <a href="../module/modbase_dynamicarrays.html">ModBase_DynamicArrays</a> module
...
!** USE STATEMENTS:
    USE Class_ListCharacter
    USE Class_ListCmpxSP
    USE Class_ListCmpxDP
    USE Class_ListCmpxQP
    USE Class_ListInteger1B
    USE Class_ListInteger2B
    USE Class_ListInteger4B
    USE Class_ListInteger8B
    USE Class_ListLogical
    USE Class_ListRealSP
    USE Class_ListRealDP
    USE Class_ListRealQP
    USE Class_ListAssignable
    USE Class_ListAnyType

END MODULE ModBase_DoublyLinkedLists
