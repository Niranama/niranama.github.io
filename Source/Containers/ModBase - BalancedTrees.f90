...
!   - the <a href="../module/class_treecharacter.html#type-treecharacter">TreeCharacter</a> type
!     for character string key type, <br>
!   - the <a href="../module/class_treeinteger1b.html#type-treeinteger1b">TreeInteger1B</a> type
!     for 1-byte (or 8-bit) integer key type, <br>
!   - the <a href="../module/class_treeinteger2b.html#type-treeinteger2b">TreeInteger2B</a> type
!     for 2-byte (or 16-bit) integer key type, <br>
!   - the <a href="../module/class_treeinteger4b.html#type-treeinteger4b">TreeInteger4B</a> type
!     for 4-byte (or 32-bit) integer key type, <br>
!   - the <a href="../module/class_treeinteger8b.html#type-treeinteger8b">TreeInteger8B</a> type
!     for 8-byte (or 64-bit) integer key type, <br>
!   - the <a href="../module/class_treerealsp.html#type-treerealsp">TreeRealSP</a> type
!     for single-precision real key type, <br>
!   - the <a href="../module/class_treerealdp.html#type-treerealdp">TreeRealDP</a> type
!     for double-precision real key type, <br>
!   - the <a href="../module/class_treerealqp.html#type-treerealqp">TreeRealQP</a> type
!     for quadruple-precision real key type, <br>
!   - the <a href="../module/class_treecomparable.html#type-treecomparable">TreeComparable</a>
...
!** USE STATEMENTS:
    USE Class_TreeCharacter
    USE Class_TreeInteger1B
    USE Class_TreeInteger2B
    USE Class_TreeInteger4B
    USE Class_TreeInteger8B
    USE Class_TreeRealSP
    USE Class_TreeRealDP
    USE Class_TreeRealQP
    USE Class_TreeComparable

END MODULE ModBase_BalancedTrees
