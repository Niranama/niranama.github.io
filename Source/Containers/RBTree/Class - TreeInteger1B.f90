...
!   type uses the Fortran intrinsic *INTEGER(KIND=kI1B)* type as the type of its stored keys
...
#define KeyTypeC        INTEGER(KIND=kI1B)
...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_TreeInteger1B'
...
END MODULE Class_TreeInteger1B
