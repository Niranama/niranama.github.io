...
!   type uses the Fortran intrinsic *REAL(KIND=kQP)* type as the type of its stored keys
...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_TreeRealQP'
