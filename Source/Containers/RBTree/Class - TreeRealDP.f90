...
!   type uses the Fortran intrinsic *REAL(KIND=kDP)* type as the type of its stored keys
...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_TreeRealDP'
