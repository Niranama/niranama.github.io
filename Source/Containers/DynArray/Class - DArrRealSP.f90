...
MODULE Class_DArrRealSP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *DArrRealSP* type and related routines.
!   The *DArrRealSP* type is a container with *REAL(KIND=kSP)* as the type
...
#define TypeAlloc       REAL(KIND=kSP), ALLOCATABLE
#define TypeArgmt       REAL(KIND=kSP)
#define TypeOfItem      REAL(KIND=kSP)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_DArrRealSP'
