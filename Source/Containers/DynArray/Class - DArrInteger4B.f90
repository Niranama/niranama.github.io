...
MODULE Class_DArrInteger4B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *DArrInteger4B* type and related routines.
!   The *DArrInteger4B* type is a container with *INTEGER(KIND=kI4B)* as the type
...
#define TypeAlloc       INTEGER(KIND=kI4B), ALLOCATABLE
#define TypeArgmt       INTEGER(KIND=kI4B)
#define TypeOfItem      INTEGER(KIND=kI4B)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_DArrInteger4B'
...
END MODULE Class_DArrInteger4B
