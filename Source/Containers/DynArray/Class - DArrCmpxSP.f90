...
MODULE Class_DArrCmpxSP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *DArrCmpxSP* type and related routines.
!   The *DArrCmpxSP* type is a container with *COMPLEX(KIND=kSP)* as the type
...
#define TypeAlloc       COMPLEX(KIND=kSP), ALLOCATABLE
#define TypeArgmt       COMPLEX(KIND=kSP)
#define TypeOfItem      COMPLEX(KIND=kSP)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_DArrCmpxSP'
