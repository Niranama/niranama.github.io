...
MODULE Class_PQInteger4B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *PQInteger4B* type and its related routines.
!   The *PQInteger4B* type is a priority-queue container with *INTEGER(KIND=kI4B)*
...
#define     KeyType     INTEGER(KIND=kI4B)
#define     PQHeap      PQInteger4B

!** MODULE PARAMETERS:
    tCharStar, PARAMETER    :: ModName = 'Class_PQInteger4B'
