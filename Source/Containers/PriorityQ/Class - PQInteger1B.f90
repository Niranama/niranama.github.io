...
MODULE Class_PQInteger1B

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *PQInteger1B* type and its related routines.
!   The *PQInteger1B* type is a priority-queue container with *INTEGER(KIND=kI1B)*
...
#define     KeyType     INTEGER(KIND=kI1B)
#define     PQHeap      PQInteger1B

!** MODULE PARAMETERS:
    tCharStar, PARAMETER    :: ModName = 'Class_PQInteger1B'
