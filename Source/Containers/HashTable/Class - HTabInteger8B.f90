...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_HTabInteger8B'
    ! Special marker token used to indicate the deletion of a key-value pair
    tSInt64,   PARAMETER    :: DELKEY = ToLong(Z'7FFFFFFFFFFFFFFF')
    ! Special marker token used to indicate the empty of a key-value pair
    tSInt64,   PARAMETER    :: NULKEY = ToLong(Z'8000000000000000')
...
END MODULE Class_HTabInteger8B
