...
#define ItemTypeA           INTEGER(KIND=kI2B)
#define ItemTypeB           INTEGER(KIND=kI2B)
#define ItemTypeC           INTEGER(KIND=kI2B)
#define TypeOfItem          INTEGER(KIND=kI2B)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_ListInteger2B'
...
END MODULE Class_ListInteger2B
