...
MODULE Class_ListRealQP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *ListRealQP* type and related routines.
!   The *ListRealQP* type is a container with *REAL(KIND=kQP)* as the type
...
#define ItemTypeA           REAL(KIND=kQP)
#define ItemTypeB           REAL(KIND=kQP)
#define ItemTypeC           REAL(KIND=kQP)
#define TypeOfItem          REAL(KIND=kQP)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_ListRealQP'
