...
#define ItemTypeA           INTEGER(KIND=kI1B)
#define ItemTypeB           INTEGER(KIND=kI1B)
#define ItemTypeC           INTEGER(KIND=kI1B)
#define TypeOfItem          INTEGER(KIND=kI1B)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_ListInteger1B'
...
END MODULE Class_ListInteger1B
