...
MODULE Class_ListRealSP

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains the *ListRealSP* type and related routines.
!   The *ListRealSP* type is a container with *REAL(KIND=kSP)* as the type
...
#define ItemTypeA           REAL(KIND=kSP)
#define ItemTypeB           REAL(KIND=kSP)
#define ItemTypeC           REAL(KIND=kSP)
#define TypeOfItem          REAL(KIND=kSP)

!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Class_ListRealSP'
