...
MODULE ModBase_MemHandlers_Comparable

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains memory management routines for a *Comparable* class.
...
!** MODULE PARAMETERS:
    ! name of module
    tCharStar, PARAMETER    :: ModName = 'Base_MemHandlers_Comparable'
...
END MODULE ModBase_MemHandlers_Comparable
