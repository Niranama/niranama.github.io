...
#ifndef __GFORTRAN__
    ! the following use statement causes internal compiler error.
    USE Class_FvlStr
#endif
...
!** MODULE PARAMETERS:
    ...
    tInteger,  PARAMETER    :: Radix   = 256        !! radix for extended ASCII
