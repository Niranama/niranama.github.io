...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tSingle,   OPTIONAL, INTENT(IN)     :: MaxVal
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(ProgressBar), INTENT(INOUT)   :: Bar
    tSingle,            INTENT(IN)      :: Value    ! the value to be used for the Position of the cursor
