...
MODULE ModBase_SLATEC_Util

!^ **PURPOSE OF THIS MODULE**: <br>
!   This module contains utility routines based on routines from SLATEC library.
!   All routines here have the same interface as their original ones but their
!   implementation have all been re-engineered.  These routines provide a simple
!   refactoring of legacy code.

!** USE STATEMENTS:
    USE ModBase_Common
    USE ModBase_Error_Handlers
    USE ModBase_IO_Handlers,    ONLY: GetNewIOUnit, IsFileOpen
    USE ModBase_MiscUtil,       ONLY: Machine_Real_Parameter, Machine_Integer_Parameter
    USE ModLib_Display,         ONLY: DISP
...
!** MODULE PARAMETERS:
    tCharStar, PARAMETER    :: ModName = 'ModBase_SLATEC'               ! module name
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger,       INTENT(IN)  :: NMES
    tInteger,       INTENT(IN)  :: NERR
    tInteger,       INTENT(IN)  :: LEVEL
    tInteger,       INTENT(IN)  :: NI
    tInteger,       INTENT(IN)  :: I1
    tInteger,       INTENT(IN)  :: I2
    tInteger,       INTENT(IN)  :: NR
...
END MODULE ModBase_SLATEC_Util
