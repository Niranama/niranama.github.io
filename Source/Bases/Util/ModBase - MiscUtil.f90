...
#ifdef  HAVE_FMLIB
    USE ModLib_FMLib,       ONLY: FM_SET, FM_SETVAR
#endif
#ifdef  HAVE_MPFUN
    USE ModLib_MPFun,       ONLY: MPINIT, MPDPW
#endif
...
!** SUBROUTINE ARGUMENT DEFINITIONS:
    tReal,     INTENT(IN)   :: Number  ! number to be displayed
    tCharStar, INTENT(IN)   :: String  ! String to be displayed
...
!** FLOW
    ...
    NumString = TrimSigDigits(Number, 4)
...
!** FLOW
    ...
    String = TRIM(TOSTRING(Value, FMT=FMT))

    ! determine the exponent part
    Pos = INDEX(String,'E')
    IF (Pos > 0) THEN
        EString = String(Pos:LEN_TRIM(String))
    ELSE
        EString = ' '
    ENDIF
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tReal, INTENT(IN)   :: Limit(:)     ! limits
    tReal, INTENT(IN)   :: Value        ! actual value
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger, INTENT(IN)    :: Limit(:)     ! limits
    tInteger, INTENT(IN)    :: Value        ! actual value
    tIndex                  :: Index        ! index of the lower limit
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tReal, INTENT(IN)   :: A
    tReal, INTENT(IN)   :: B
    tReal, INTENT(OUT)  :: MIN
    tReal, INTENT(OUT)  :: MAX
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tInteger, INTENT(OUT)   :: MIN
    tInteger, INTENT(OUT)   :: MAX
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tReal, INTENT(IN)   :: Value
    tReal, INTENT(IN)   :: UppLimit
    tReal, INTENT(IN)   :: LowLimit
    tLogical            :: OutVal
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger, INTENT(IN)    :: Value
    tInteger, INTENT(IN)    :: UppLimit
    tInteger, INTENT(IN)    :: LowLimit
    tLogical                :: OutVal
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tLong, INTENT(IN)   :: Value
    tLong, INTENT(IN)   :: UppLimit
    tLong, INTENT(IN)   :: LowLimit
    tLogical            :: OutVal
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tReal,  INTENT(IN)      :: Array(:)     ! input array
    tIndex, INTENT(IN)      :: FirstLoc     ! first position of actual array
    tReal,  INTENT(INOUT)   :: MaxVal       ! maximum value
...
!** SUBROUTINE PARAMETER DECLARATIONS:
    tInteger, PARAMETER     :: BaseNum = RADIX(One) ! the base for floating point (double precision) number
...
!** SUBROUTINE PARAMETER DECLARATIONS:
    tInteger, PARAMETER     :: BitInt   = BIT_SIZE(1)           ! the number of bits per integer storage unit
    tInteger, PARAMETER     :: BaseInt  = RADIX(1)              ! the base for integer number
    tInteger, PARAMETER     :: BaseNum  = RADIX(1.0D0)          ! the base for floating point number
    tInteger, PARAMETER     :: IntHuge  = HUGE(1)               ! the largest integer number
    tInteger, PARAMETER     :: IntDigit = DIGITS(1)             ! the number of significant digits for
                                                                !   integer number
    tInteger, PARAMETER     :: DPDigit  = DIGITS(1.0D0)         ! the number of significant digits for
                                                                !   double-precision floating point number
    tInteger, PARAMETER     :: SPDigit  = DIGITS(1.0E0)         ! the number of significant digits for
                                                                !   single-precision floating point number
    tInteger, PARAMETER     :: DPExpMin = MINEXPONENT(1.0D0)    ! the smallest exponent E for
                                                                !   double-precision floating point number
    tInteger, PARAMETER     :: DPExpMax = MAXEXPONENT(1.0D0)    ! the largest exponent E for
                                                                !   double-precision floating point number
    tInteger, PARAMETER     :: SPExpMin = MINEXPONENT(1.0E0)    ! the smallest exponent E for
                                                                !   single-precision floating point number
    tInteger, PARAMETER     :: SPExpMax = MAXEXPONENT(1.0E0)    ! the largest exponent E for
                                                                !   single-precision floating point number
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tReal,  INTENT(INOUT)   :: AVal(:)      ! values of A
    tReal,  INTENT(INOUT)   :: BVal(:)      ! values of B
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tIndex,   INTENT(IN)    :: IBegin       ! starting index
    tIndex,   INTENT(IN)    :: IEnd         ! ending index
    tInteger, INTENT(INOUT) :: AVal(:)      ! values of A
    tInteger, INTENT(INOUT) :: BVal(:)      ! values of B
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger, INTENT(IN)    :: Val      ! value to be shifted
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger, INTENT(IN)    :: DayOfMonth   !! day of month
    tInteger, INTENT(IN)    :: Month        !! month
    tInteger                :: DNum         !! day number
...
!** SUBROUTINE ARGUMENT DEFINITIONS:
    tInteger, INTENT(IN)    :: Day           !! Day of Month, not validated by month
    tInteger, INTENT(IN)    :: Month         !! Month, 1..12
    tInteger, INTENT(IN)    :: LeapYearValue !! 1 if leap year indicated, 0 if not
    tInteger                :: DNum          !! day number
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tReal, INTENT(IN)   :: AVal
    tReal, INTENT(IN)   :: BVal
    tLogical            :: OutVal
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger, INTENT(INOUT) :: AVal ! value of A
    tInteger, INTENT(INOUT) :: BVal ! value of B
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tReal, INTENT(INOUT)    :: AVal ! value of A
    tReal, INTENT(INOUT)    :: BVal ! value of B
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tCmpx, INTENT(INOUT)    :: AVal ! value of A
    tCmpx, INTENT(INOUT)    :: BVal ! value of B
...
!** FLOW
    ...
    Flag = (1_kI2B == TRANSFER([1_kI1B, 0_kI1B], 0_kI2B))
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger, OPTIONAL, INTENT(IN)  :: NPrec    !! precision for FM, IM and ZM types
    tInteger, OPTIONAL, INTENT(IN)  :: KW       !! output unit for FMLib
...
! FLOW
    ...
    VarOption = 'KW = ' // TRIM(TOSTRING(ErrOutUnit))
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger, OPTIONAL, INTENT(IN)  :: NPrec    !! precision for MPR and MPC types
