...
SUBMODULE (Class_ApInt32) SubClass_Api32_Auxiliary

!^ **PURPOSE OF THIS SUBMODULE**: <br>
!   This submodule contains an implementation for various auxiliary routines
!   of the <a href="../module/class_apint32.html">ApInt32</a> type.
...
!** SUBMODULE PARAMETERS:
    tCharStar, PARAMETER    :: SubName  = 'SubClass_Api32_Auxiliary'
...
!** GENERIC DECLARATIONS:
    INTERFACE  AssignUnsigned
        MODULE PROCEDURE Assign_U32_To_ApInt32, Assign_U64_To_ApInt32
        MODULE PROCEDURE Assign_U32_To_ApInt32_NoSign, Assign_U64_To_ApInt32_NoSign
        MODULE PROCEDURE Assign_U128_To_ApInt32, Assign_U128_To_ApInt32_NoSign
    END INTERFACE
    INTERFACE  AssignSigned
        MODULE PROCEDURE Assign_I32_To_ApInt32, Assign_I64_To_ApInt32
        MODULE PROCEDURE Assign_I128_To_ApInt32
    END INTERFACE
...
!** PURPOSE OF THIS SUBROUTINE:
    ! To make a copy of ApInt32 using the specified source

!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(ApInt32),   INTENT(IN)    :: Source
    tIndex, OPTIONAL, INTENT(IN)    :: Capacity
    TYPE(ApInt32)                   :: Destination
...
!** FLOW
    ...
    IF (ALLOCATED(Source%Digit)) THEN
        ...
        IF (DstSize > Source%Length) Destination%Digit(Source%Length:DstSize-1) = 0
    ELSE
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tInteger,  OPTIONAL, INTENT(IN)     :: Unit             ! output logical unit
    tInteger,  OPTIONAL, INTENT(OUT)    :: IOStat           ! io stat
    tCharStar, OPTIONAL, INTENT(OUT)    :: IOMsg            ! io message
    tLogical,  OPTIONAL, INTENT(IN)     :: ShowComponent    ! flag
    ! if flag is present and true, write components of the object
...
!** PURPOSE OF THIS SUBROUTINE:
    ! To ApInt32 number with zero value
...
!** PURPOSE OF THIS SUBROUTINE:
    ! To check whether the number is one or not
...
!** FLOW
    ...
    IF (ALLOCATED(Big%Digit)) THEN
        Flag = (Big%Length == 1_kIndex).AND.(Big%Digit(0) == 1).AND.(Big%Sign == 1)
    ELSE
        Flag = FalseVal
    END IF
...
!** SUBROUTINE PARAMETER DECLARATIONS:
    tInteger, PARAMETER :: RngAlgo = I32_MT
    tInteger, PARAMETER :: MaxLen  = 100
...
!** FLOW
    ...
    ELSE
        LocRng = CreateIntegerRng(RngAlgo)
        BigRng => LocRng
    END IF
...
!** FLOW
    ...
    DO I = 0, Length-1
        BigRnd%Digit(I) = Prng%NextInteger()
    END DO
...
END SUBMODULE SubClass_Api32_Auxiliary
