...
!   similar to those operations used in the <a href="../module/modbase_uintutil.html">
!   ModBase_UIntUtil</a> module.  For a 128-bit signed integer, use the
!   <a href="../module/modbase_sint128.html#type-sint128">SInt128</a> type.
!   For an (either signed or unsigned) integer with higher precision, use the
!   <a href="../module/class_apint64.html#type-apint64">ApInt64</a> type.  <br>
!   <br>
!  **Important Notes**: <br>
...
!** USE STATEMENTS:
    ...
    USE ModBase_LargeTables,            ONLY: RecTable, Char2Digits, Char4Digits
...
!** MODULE PARAMETERS:
    ! module name
    tCharParam          :: ModName = 'ModBase_UInt128'
