...
!   Similar to the <a href="../module/modbase_uint128.html#type-uint128">UInt128</a>
...
!   <a href="../module/modbase_uint128.html#type-uint128">UInt128</a> type instead.
!   Also, for an (either signed or unsigned) integer with higher precision, use the
!   <a href="../module/class_apint64.html#type-apint64">ApInt64</a> type instead. <br>
!   <br>
!  **Important Notes**: <br>
...
!** USE STATEMENTS:
    ...
    USE ModBase_UInt128
    USE ModBase_LargeTables,            ONLY: Char1Digit
...
!** MODULE PARAMETERS:
    ! module name
    tCharParam          :: ModName = 'ModBase_SInt128'
...
!** INTERFACE DEFINITIONS:
    ...
    INTERFACE SInt128
        ...
        !   --->    I128 = UInt128('-1234567890987654321011223344')
