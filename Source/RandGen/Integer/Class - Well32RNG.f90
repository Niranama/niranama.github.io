...
!** USE STATEMENTS:
    USE ModBase_Common
    USE ModBase_Memory_Handlers,    ONLY: MemAlloc, MemFree
    USE Class_BaseRNG
...
!** MODULE PARAMETERS:
    ! Block size
    tInteger, PARAMETER :: BLOCK_SIZE = 32
    ! parameters for WELL512a
    tInteger, PARAMETER :: K_512  = 512
    tInteger, PARAMETER :: M1_512 = 13
    tInteger, PARAMETER :: M2_512 = 9
    tInteger, PARAMETER :: M3_512 = 5
    ! parameters for WELL1024a
    tInteger, PARAMETER :: K_1024  = 1024
    tInteger, PARAMETER :: M1_1024 = 3
    tInteger, PARAMETER :: M2_1024 = 24
    tInteger, PARAMETER :: M3_1024 = 10
    ! parameters for WELL19937a and WELL19937c
    tInteger, PARAMETER :: K_19937  = 19937
    tInteger, PARAMETER :: M1_19937 = 70
    tInteger, PARAMETER :: M2_19937 = 179
    tInteger, PARAMETER :: M3_19937 = 449
    ! parameters for WELL49937a and WELL49937b
    tInteger, PARAMETER :: K_49937  = 49937
    tInteger, PARAMETER :: M1_49937 = 23
    tInteger, PARAMETER :: M2_49937 = 481
    tInteger, PARAMETER :: M3_49937 = 229
    ! parameters for algorithm flag
    tInteger, PARAMETER, PUBLIC :: WELL512a   = 1   !! flag for Well512a PRNG
    tInteger, PARAMETER, PUBLIC :: WELL1024a  = 2   !! flag for Well1024a PRNG
    tInteger, PARAMETER, PUBLIC :: WELL19937a = 3   !! flag for Well19937a PRNG
    tInteger, PARAMETER, PUBLIC :: WELL19937c = 4   !! flag for Well19937c PRNG
    tInteger, PARAMETER, PUBLIC :: WELL49937a = 5   !! flag for Well49937a PRNG
    tInteger, PARAMETER, PUBLIC :: WELL49937b = 6   !! flag for Well49937b PRNG
...
!** DERIVED TYPE DEFINITIONS
    ...
    TYPE, EXTENDS(IntegerRNG)  :: Well32RNG
        ...
        tInteger                    :: Index
        ! Bytes pool
        tInteger,    ALLOCATABLE    :: V(:)
        ! Index indirection table giving for each index its predecessor taking table size into account.
        tInteger,    ALLOCATABLE    :: IRm1(:)
        ! Index indirection table giving for each index its second predecessor taking table size into account.
        tInteger,    ALLOCATABLE    :: IRm2(:)
        ! Index indirection table giving for each index the value index + m1 taking table size into account.
        tInteger,    ALLOCATABLE    :: I1(:)
        ! Index indirection table giving for each index the value index + m2 taking table size into account.
        tInteger,    ALLOCATABLE    :: I2(:)
        ! Index indirection table giving for each index the value index + m3 taking table size into account.
        tInteger,    ALLOCATABLE    :: I3(:)
        ! algorithm flag
        tInteger                    :: WellAlgo = WELL49937b
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tInteger,           INTENT(IN)      :: WellAlgo
    !% optional seed(s)
    tInteger, OPTIONAL, INTENT(IN)      :: Seed(:)
...
! FLOW
    ...
    !** SUBROUTINE ARGUMENT DECLARATIONS:
        CLASS(Well32RNG), INTENT(INOUT) :: RNG      !! 'Well32RNG' object
        tInteger,         INTENT(IN)    :: K        !! number of bits in the pool
        tInteger,         INTENT(IN)    :: M1       !! first parameter of the algorithm
        tInteger,         INTENT(IN)    :: M2       !! second parameter of the algorithm
        tInteger,         INTENT(IN)    :: M3       !! third parameter of the algorithm
        tInteger,         INTENT(IN)    :: Seed(:)  !! seeds
    ...
    ! FLOW
        ...
        DO I = SeedSize, SIZE(State)-1
            ...
            State(I) = ToInteger(IAND((1812433253_kLong * IEOR(Current, SHIFTA(Current, 30)) + I), Mask))
        END DO
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger, INTENT(IN)    :: K        ! Number of bits in the pool
    tInteger                :: Count    ! the number of 32-bits blocks
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tInteger,         INTENT(IN)    :: Index    ! index the index to look at
    tInteger                        :: IndxOut  ! (index - 1) % table size
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(Well32RNG), INTENT(IN)    :: RNG      ! 'Well32RNG' object
    tInteger,         INTENT(IN)    :: Index    ! index the index to look at
    tInteger                        :: IndxOut  ! (index - 2) % table size
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(Well32RNG), INTENT(IN)    :: RNG      ! 'Well32RNG' object
    tInteger,         INTENT(IN)    :: Index    ! index the index to look at
    tInteger                        :: IndxOut  ! (index + M1) % table size
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(Well32RNG), INTENT(IN)    :: RNG      ! 'Well32RNG' object
    tInteger,         INTENT(IN)    :: Index    ! index the index to look at
    tInteger                        :: IndxOut  ! (index + M2) % table size
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    CLASS(Well32RNG), INTENT(IN)    :: RNG      ! 'Well32RNG' object
    tInteger,         INTENT(IN)    :: Index    ! index the index to look at
    tInteger                        :: IndxOut  ! (index + M3) % table size
...
!** SUBROUTINE PARAMETER DECLARATIONS:
    tInteger, PARAMETER :: CPAR = ToInteger(Z'DA442D24')

!** SUBROUTINE INTERNAL VARIABLE DECLARATIONS:
    tInteger    :: IndexRm1, VI, VI1, VI2
    tInteger    :: Z0, Z1, Z2, Z3, Z4
...
!** SUBROUTINE INTERNAL VARIABLE DECLARATIONS:
    tInteger    :: IndexRm1, V0, VM1, VM2, VM3
    tInteger    :: Z0, Z1, Z2, Z3, Z4
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger, PARAMETER :: MaskA = ToInteger(Z'7FFFFFFF')
    tInteger, PARAMETER :: MaskB = ToInteger(Z'80000000')
    tInteger, PARAMETER :: C1 = ToInteger(Z'E46E1700')
    tInteger, PARAMETER :: C2 = ToInteger(Z'9B868000')

!** SUBROUTINE INTERNAL VARIABLE DECLARATIONS:
    tInteger    :: IndexRm1, IndexRm2, V0, VM1, VM2, VM3
    tInteger    :: Z0, Z1, Z2, Z3, Z4
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    tInteger, PARAMETER :: MaskA = ToInteger(Z'00007FFF')
    tInteger, PARAMETER :: MaskB = ToInteger(Z'FFFF8000')
    tInteger, PARAMETER :: M1 = ToInteger(Z'FBFFFFFF')
    tInteger, PARAMETER :: M2 = ToInteger(Z'00020000')
    tInteger, PARAMETER :: M3 = ToInteger(Z'B729FCEC')
    tInteger, PARAMETER :: C1 = ToInteger(Z'93DD1400')
    tInteger, PARAMETER :: C2 = ToInteger(Z'FA118000')

!** SUBROUTINE INTERNAL VARIABLE DECLARATIONS:
    tInteger    :: IndexRm1, IndexRm2, V0, VM1, VM2, VM3
    tInteger    :: Z0, Z1, Z2, Z3, Z4, Z2Prime, Z2Second
