...
!** USE STATEMENTS:
    USE ModBase_Common
    USE ModBase_UIntUtil,   ONLY: OPERATOR(.ULT.), ToUnsignedLong
    USE Class_BaseRNG
...
!** MODULE PARAMETERS:
    ...
    ! Multiply
    tLong,    PARAMETER :: C_MAX = 809430660_kLong
    ! Multiply
    tLong,    PARAMETER :: A = 18782_kLong
    ! Complimentary
    tInteger, PARAMETER :: R = ToInteger(Z'FFFFFFFE')
...
! FLOW
    ...
    RNG%Carry = ToInteger(MOD(ABS(ToUnsignedLong(Seed0(Q_SIZE))), C_MAX))
...
!** SUBROUTINE PARAMETER DECLARATIONS:
    tInteger, PARAMETER :: MaskB = ToInteger(Z'00000FFF')
...
! FLOW
    ...
    RNG%Carry = ToInteger(SHIFTR(T, 32))
    X = ToInteger(T + RNG%Carry)
