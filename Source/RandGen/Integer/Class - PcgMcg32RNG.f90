...
! FLOW
    ...
    LngSeed = IOR(IAND(ToLong(IntSeed(1)), MaskL), SHIFTL(ToLong(IntSeed(2)), 32)) &
              + GOLDEN_RATIO_64
...
! FLOW
    ...
    Output = Input * 6364136223846793005_kLong
    ASSOCIATE (Dummy => RNG); END ASSOCIATE
