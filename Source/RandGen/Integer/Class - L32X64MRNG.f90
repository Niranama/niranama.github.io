...
!** MODULE PARAMETERS:
    ...
    tInteger, PARAMETER :: M32P = ToInteger(Z'65640001')
    ...
    ! s = m' * s + c' * c
    tInteger, PARAMETER :: C32P = ToInteger(Z'046B0000')
...
! FLOW
    ...
    Seed0(1) = ToInteger(SHIFTL(LongSeed, 1))
