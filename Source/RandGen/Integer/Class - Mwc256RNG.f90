...
!** MODULE PARAMETERS:
    ...
    ! Multiply
    tLong,  PARAMETER   :: A = 809430660_kLong
...
! FLOW
    ...
    RNG%Carry = ToInteger(MOD(ABS(ToLong(Seed0(Q_SIZE))), A))
...
!** SUBROUTINE PARAMETER DECLARATIONS:
    tInteger, PARAMETER :: MaskB = ToInteger(Z'000000FF')
...
! FLOW
    ...
    T = A * IAND(ToLong(RNG%State(RNG%Index)), MaskL) + RNG%Carry
    RandNum = ToInteger(T)
