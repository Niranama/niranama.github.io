...
!** MODULE PARAMETERS:
    ...
    tInteger, PARAMETER :: MaxLevel = 4
    ! default luxury level
    tInteger, PARAMETER :: LuxLevDflt = 3
    ! default seed
    tInteger, PARAMETER :: SeedDflt = 314159265
    ! 2**12
    tSingle,  PARAMETER :: TwoPow12 = 4096.0
    ! 2**24
    tInteger, PARAMETER :: ITwoPow24 = 2**24
    ! constant
    tInteger, PARAMETER :: ICons = 2147483563
    ! number of additional random numbers that need to be 'thrown away'
    ! every 24 numbers is set using 'LuxLev' variable.
    tInteger, PARAMETER :: NdSkip(0:MaxLevel) = [0, 24, 73, 199, 365]
    tInteger, PARAMETER :: IGiga = 1000000000
...
!** SUBROUTINE PARAMETER DECLARATIONS:
    tSingle, PARAMETER  :: Diff = ToSingle(MAX_I32) - ToSingle(MIN_I32)
...
! FLOW
    ...
    RandNum = ToInteger(RNG%NextSingle()*Diff) + MIN_I32
