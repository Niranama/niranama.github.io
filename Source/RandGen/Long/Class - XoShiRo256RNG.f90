...
!** MODULE PARAMETERS:
    ...
    tInteger, PARAMETER :: SEED_SIZE = 4
    ! The coefficients for the jump function
    tLong,    PARAMETER :: JUMP_COEFFICIENTS(0:SEED_SIZE-1) = [             &
        ToLong(Z'180EC6D33CFD0ABA'), ToLong(Z'D5A61266F0C9392C'), &
        ToLong(Z'A9582618E03FC9AA'), ToLong(Z'39ABDC4529B1661C')]
    ! The coefficients for the long jump function
    tLong,    PARAMETER :: LONG_JUMP_COEFFICIENTS(0:SEED_SIZE-1) = [        &
        ToLong(Z'76E15D3EFEFDCBBF'), ToLong(Z'C5004E441C522FB3'), &
        ToLong(Z'77710069854EE241'), ToLong(Z'39109BB02ACBE635')]
    ! Parameters for algorithm flag
    tInteger, PARAMETER, PUBLIC :: XoShiRo256StarStar = 1 !! flag for XoShiRo256StarStar PRNG
    tInteger, PARAMETER, PUBLIC :: XoShiRo256Plus     = 2 !! flag for XoShiRo256Plus PRNG
    tInteger, PARAMETER, PUBLIC :: XoShiRo256PlusPlus = 3 !! flag for XoShiRo256PlusPlus PRNG
...
!** DERIVED TYPE DEFINITIONS
    ...
    TYPE, EXTENDS(LongRNG)  :: XoShiRo256RNG
        PRIVATE
        ! states
        tLong    :: State0, State1, State2, State3
        ! algorithm flag
        tInteger    :: XoShiRoAlgo = XoShiRo256StarStar
...
END MODULE Class_XoShiRo256RNG
