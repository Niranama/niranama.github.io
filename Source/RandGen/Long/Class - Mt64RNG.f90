...
!** MODULE PARAMETERS:
    ...
    tLong,    PARAMETER :: UM = ToLong(Z'FFFFFFFF80000000')
    ! Least significant 31 bits.
    tLong,    PARAMETER :: LM = ToLong(Z'000000007FFFFFFF')
    ! Size of the bytes pool.
    tInteger, PARAMETER :: NN = 312
    ! Period second parameter.
    tInteger, PARAMETER :: MM = 156
    ! X * MATRIX_A for X = {0, 1}.
    tLong,    PARAMETER :: MAG01(0:1) = [0_kLong, ToLong(Z'B5026F5AA96619E9')]
...
! FLOW
    ...
    !** SUBROUTINE PARAMETER DECLARATIONS:
        tLong, PARAMETER    :: C1 = ToLong(Z'369DEA0F31A53F85')
        tLong, PARAMETER    :: C2 = ToLong(Z'27BB2EE687B0B0FD')
        tLong, PARAMETER    :: C3 = ToLong(Z'8000000000000000')
        
    !** SUBROUTINE INTERNAL VARIABLE DECLARATIONS:
        tInteger    :: I, J, K, SeedSize
        tLong       :: MM1

    ! FLOW
    
        CALL Initialize_State(19650218_kLong, State)
    ...
    !** SUBROUTINE ARGUMENT DECLARATIONS:
        tLong, INTENT(IN)   :: Seed
        tLong, INTENT(OUT)  :: State(0:)

    !** SUBROUTINE PARAMETER DECLARATIONS:
        tLong, PARAMETER    :: CPAR = ToLong(Z'5851F42D4C957F2D')
...
!** SUBROUTINE PARAMETER DECLARATIONS:
    tLong, PARAMETER    :: C1 = ToLong(Z'5555555555555555')
    tLong, PARAMETER    :: C2 = ToLong(Z'71d67fffeda60000')
    tLong, PARAMETER    :: C3 = ToLong(Z'fff7eee000000000')
    ...
    IF (RNG%MTI >= NN) THEN
        ...
        DO I = 0, NN - MM -1
            ...
            RNG%MT(I) = IEOR(IEOR(RNG%MT(I + MM), SHIFTR(X, 1)), &
                             MAG01(ToInteger(IAND(X, 1_kLong))))
        END DO
        DO I = NN - MM, NN - 2
            X = IOR(IAND(RNG%MT(I), UM), IAND(RNG%MT(I + 1), LM))
