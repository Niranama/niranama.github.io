...
!** MODULE PARAMETERS:
    ...
    tInteger, PARAMETER :: SEED_SIZE = 3
    ! The default seed
    ! This has a high quality Weyl increment (containing many bit state transitions).
    tLong,    PARAMETER :: DEFAULT_SEED(1:SEED_SIZE) = [ToLong(Z'012DE1BABB3C4104'), &
                           ToLong(Z'C8161B4202294965'), ToLong(Z'B5AD4ECEDA1CE2A9')]
...
!** SUBROUTINE PARAMETER DECLARATIONS:
    tLong, PARAMETER :: Mask = ToLong(Z'FFFFFFFF00000000')
