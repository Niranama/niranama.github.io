...
!** MODULE PARAMETERS:
    ...
    tInteger, PARAMETER :: SEED_SIZE = 2
    ! The coefficients for the jump function
    tLong,    PARAMETER :: JUMP_COEFFICIENTS(0:SEED_SIZE-1) = [ &
        ToLong(Z'DF900294D8F554A5'), ToLong(Z'170865DF4B3201FC')]
    ! The coefficients for the long jump function
    tLong,    PARAMETER :: LONG_JUMP_COEFFICIENTS(0:SEED_SIZE-1) = [ &
        ToLong(Z'D2A98B26625EEE7B'), ToLong(Z'DDDF9B1090AA7AC1')]
    ! The coefficients for the jump function for XoRoShiRo128PlusPlus
    tLong,    PARAMETER :: JUMP_COEF_PLUSPLUS(0:SEED_SIZE-1) = [ &
        ToLong(Z'2BD7A6A6E99C2DDC'), ToLong(Z'0992CCAF6A6FCA05')]
    ! The coefficients for the long jump function for XoRoShiRo128PlusPlus
    tLong,    PARAMETER :: LONG_JUMP_COEF_PLUSPLUS(0:SEED_SIZE-1) = [ &
        ToLong(Z'360FD5F2CF8D5D99'), ToLong(Z'9C6E6877736C46E3')]
    ! Parameters for algorithm flag
    tInteger, PARAMETER, PUBLIC :: XoRoShiRo128StarStar = 1 !! flag for XoRoShiRo128StarStar PRNG
    tInteger, PARAMETER, PUBLIC :: XoRoShiRo128Plus     = 2 !! flag for XoRoShiRo128Plus PRNG
    tInteger, PARAMETER, PUBLIC :: XoRoShiRo128PlusPlus = 3 !! flag for XoRoShiRo128PlusPlus PRNG
...
!** DERIVED TYPE DEFINITIONS
    ...
    TYPE, EXTENDS(LongRNG)  :: XoRoShiRo128RNG
        ...
        tLong       :: State0, State1
        ! algorithm flag
        tInteger    :: XoRoShiRoAlgo = XoRoShiRo128StarStar
...
END MODULE Class_XoRoShiRo128RNG
