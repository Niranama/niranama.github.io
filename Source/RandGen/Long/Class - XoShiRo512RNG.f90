...
!** MODULE PARAMETERS:
    ...
    tInteger, PARAMETER :: SEED_SIZE = 8
    ! The coefficients for the jump function
    tLong,    PARAMETER :: JUMP_COEFFICIENTS(0:SEED_SIZE-1) = [   &
        ToLong(Z'33ED89B6E7A353F9'), ToLong(Z'760083D7955323BE'), &
        ToLong(Z'2837F2FBB5F22FAE'), ToLong(Z'4B8C5674D309511C'), &
        ToLong(Z'B11AC47A7BA28C25'), ToLong(Z'F1BE7667092BCC1C'), &
        ToLong(Z'53851EFDB6DF0AAF'), ToLong(Z'1EBBC8B23EAF25DB')]
    ! The coefficients for the long jump function
    tLong,    PARAMETER :: LONG_JUMP_COEFFICIENTS(0:SEED_SIZE-1) = [ &
        ToLong(Z'11467FEF8F921D28'), ToLong(Z'A2A819F2E79C8EA8'),    &
        ToLong(Z'A8299FC284B3959A'), ToLong(Z'B4D347340CA63EE1'),    &
        ToLong(Z'1CB0940BEDBFF6CE'), ToLong(Z'D956C5C4FA1F8E17'),    &
        ToLong(Z'915E38FD4EDA93BC'), ToLong(Z'5B3CCDFA5D7DACA5')]
    ! Parameters for algorithm flag
    tInteger, PARAMETER, PUBLIC :: XoShiRo512StarStar = 1 !! flag for XoShiRo512StarStar PRNG
    tInteger, PARAMETER, PUBLIC :: XoShiRo512Plus     = 2 !! flag for XoShiRo512Plus PRNG
    tInteger, PARAMETER, PUBLIC :: XoShiRo512PlusPlus = 3 !! flag for XoShiRo512PlusPlus PRNG
...
!** DERIVED TYPE DEFINITIONS
    ...
    TYPE, EXTENDS(LongRNG)  :: XoShiRo512RNG
        ...
        ! algorithm flag
        tInteger    :: XoShiRoAlgo = XoShiRo512StarStar
...
!** SUBROUTINE ARGUMENT DECLARATIONS:
    ...
    tInteger,             INTENT(IN)    :: XoShiRoAlgo
...
END MODULE Class_XoShiRo512RNG
