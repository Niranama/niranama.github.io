...
!** SUBROUTINE PARAMETER DECLARATIONS:
    ...
    tDouble, PARAMETER  :: DNorm1 = 2.0_kDouble**(-53)
    tDouble, PARAMETER  :: DNorm2 = 1.0_kDouble/SHIFTL(1_kLong, 53)
    tDouble, PARAMETER  :: DNorm3 = 0.5_kDouble*EPSILON(1.0_kDouble)
...
! FLOW
    ...
    High = SHIFTL(ToLong(SHIFTR(RNG%NextInteger(), 6)), 27)     ! 26-bits remain
    Low  = ToLong(SHIFTR(RNG%NextInteger(), 5))                 ! 27-bits remain
