...
#include    "Includes/HamsiS_Constants.f90"
    ...
    tInteger, PARAMETER :: IV224(0:7) = [                   &
            ToInteger(Z'c3967a67'), ToInteger(Z'c3bc6c20'), &
            ToInteger(Z'4bc3bcc3'), ToInteger(Z'a7c3bc6b'), &
            ToInteger(Z'2c204b61'), ToInteger(Z'74686f6c'), &
            ToInteger(Z'69656b65'), ToInteger(Z'20556e69')]
    tInteger, PARAMETER :: IV256(0:7) = [                   &
            ToInteger(Z'76657273'), ToInteger(Z'69746569'), &
            ToInteger(Z'74204c65'), ToInteger(Z'7576656e'), &
            ToInteger(Z'2c204465'), ToInteger(Z'70617274'), &
            ToInteger(Z'656d656e'), ToInteger(Z'7420456c')]
...
! FLOW
    ...
    CALL ByteUnpackBE(MD%BitCount + SHIFTL(Ptr, 3) + ToLong(NBits), Pad, 4_kIndex)
...
! FLOW
    ...
    ! initialize
    MD%BitCount = MD%BitCount + SHIFTL(ToLong(Length), 5)
    Num   = Length
    CurID = Offset
    READ_STATE_SMALL(VC)
