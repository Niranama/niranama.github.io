...
!** MODULE PARAMETERS:
    ...
    tInteger, PARAMETER :: IV224(0:15) = [                  &
            ToInteger(Z'00010203'), ToInteger(Z'04050607'), &
            ToInteger(Z'08090A0B'), ToInteger(Z'0C0D0E0F'), &
            ToInteger(Z'10111213'), ToInteger(Z'14151617'), &
            ToInteger(Z'18191A1B'), ToInteger(Z'1C1D1E1F'), &
            ToInteger(Z'20212223'), ToInteger(Z'24252627'), &
            ToInteger(Z'28292A2B'), ToInteger(Z'2C2D2E2F'), &
            ToInteger(Z'30313233'), ToInteger(Z'34353637'), &
            ToInteger(Z'38393A3B'), ToInteger(Z'3C3D3E3F')]
    tInteger, PARAMETER :: IV256(0:15) = [                  &
            ToInteger(Z'40414243'), ToInteger(Z'44454647'), &
            ToInteger(Z'48494A4B'), ToInteger(Z'4C4D4E4F'), &
            ToInteger(Z'50515253'), ToInteger(Z'54555657'), &
            ToInteger(Z'58595A5B'), ToInteger(Z'5C5D5E5F'), &
            ToInteger(Z'60616263'), ToInteger(Z'64656667'), &
            ToInteger(Z'68696A6B'), ToInteger(Z'6C6D6E6F'), &
            ToInteger(Z'70717273'), ToInteger(Z'74757677'), &
            ToInteger(Z'78797A7B'), ToInteger(Z'7C7D7E7F')]
    tInteger, PARAMETER :: FINAL_PARAM(0:15) = [            &
            ToInteger(Z'AAAAAAA0'), ToInteger(Z'AAAAAAA1'), &
            ToInteger(Z'AAAAAAA2'), ToInteger(Z'AAAAAAA3'), &
            ToInteger(Z'AAAAAAA4'), ToInteger(Z'AAAAAAA5'), &
            ToInteger(Z'AAAAAAA6'), ToInteger(Z'AAAAAAA7'), &
            ToInteger(Z'AAAAAAA8'), ToInteger(Z'AAAAAAA9'), &
            ToInteger(Z'AAAAAAAA'), ToInteger(Z'AAAAAAAB'), &
            ToInteger(Z'AAAAAAAC'), ToInteger(Z'AAAAAAAD'), &
            ToInteger(Z'AAAAAAAE'), ToInteger(Z'AAAAAAAF')]
...
! FLOW
    ...
    ASSOCIATE(TmpBuf => MD%BufArr)   
        Ptr = MD%GetBufLen()
        BitLen = SHIFTL(ToLong(MD%GetBlockCount()), 9) + SHIFTL(ToLong(Ptr), 3)
        ...
        CALL ByteUnpackLE(ToInteger(BitLen) + NBits, TmpBuf, 56_kIndex)
        CALL ByteUnpackLE(ToInteger(SHIFTR(BitLen, 32)), TmpBuf, 60_kIndex)
        CALL MD%ProcessBlock(TmpBuf)
    END ASSOCIATE
...
#define KS(j)       (j * ToInteger(Z'05555555'))
