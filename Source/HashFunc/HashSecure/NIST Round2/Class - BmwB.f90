...
!** MODULE PARAMETERS:
    ...
    tLong,  PARAMETER   :: IV384(0:15) = [                            &
            ToLong(Z'0001020304050607'), ToLong(Z'08090A0B0C0D0E0F'), &
            ToLong(Z'1011121314151617'), ToLong(Z'18191A1B1C1D1E1F'), &
            ToLong(Z'2021222324252627'), ToLong(Z'28292A2B2C2D2E2F'), &
            ToLong(Z'3031323334353637'), ToLong(Z'38393A3B3C3D3E3F'), &
            ToLong(Z'4041424344454647'), ToLong(Z'48494A4B4C4D4E4F'), &
            ToLong(Z'5051525354555657'), ToLong(Z'58595A5B5C5D5E5F'), &
            ToLong(Z'6061626364656667'), ToLong(Z'68696A6B6C6D6E6F'), &
            ToLong(Z'7071727374757677'), ToLong(Z'78797A7B7C7D7E7F')]
    tLong,  PARAMETER   :: IV512(0:15) = [                            &
            ToLong(Z'8081828384858687'), ToLong(Z'88898A8B8C8D8E8F'), &
            ToLong(Z'9091929394959697'), ToLong(Z'98999A9B9C9D9E9F'), &
            ToLong(Z'A0A1A2A3A4A5A6A7'), ToLong(Z'A8A9AAABACADAEAF'), &
            ToLong(Z'B0B1B2B3B4B5B6B7'), ToLong(Z'B8B9BABBBCBDBEBF'), &
            ToLong(Z'C0C1C2C3C4C5C6C7'), ToLong(Z'C8C9CACBCCCDCECF'), &
            ToLong(Z'D0D1D2D3D4D5D6D7'), ToLong(Z'D8D9DADBDCDDDEDF'), &
            ToLong(Z'E0E1E2E3E4E5E6E7'), ToLong(Z'E8E9EAEBECEDEEEF'), &
            ToLong(Z'F0F1F2F3F4F5F6F7'), ToLong(Z'F8F9FAFBFCFDFEFF')]
    tLong,  PARAMETER   :: FINAL_PARAM(0:15) = [                      &
            ToLong(Z'AAAAAAAAAAAAAAA0'), ToLong(Z'AAAAAAAAAAAAAAA1'), &
            ToLong(Z'AAAAAAAAAAAAAAA2'), ToLong(Z'AAAAAAAAAAAAAAA3'), &
            ToLong(Z'AAAAAAAAAAAAAAA4'), ToLong(Z'AAAAAAAAAAAAAAA5'), &
            ToLong(Z'AAAAAAAAAAAAAAA6'), ToLong(Z'AAAAAAAAAAAAAAA7'), &
            ToLong(Z'AAAAAAAAAAAAAAA8'), ToLong(Z'AAAAAAAAAAAAAAA9'), &
            ToLong(Z'AAAAAAAAAAAAAAAA'), ToLong(Z'AAAAAAAAAAAAAAAB'), &
            ToLong(Z'AAAAAAAAAAAAAAAC'), ToLong(Z'AAAAAAAAAAAAAAAD'), &
            ToLong(Z'AAAAAAAAAAAAAAAE'), ToLong(Z'AAAAAAAAAAAAAAAF')]
...
! FLOW
    ...
    ASSOCIATE(TmpBuf => MD%BufArr)   
        Ptr = MD%GetBufLen()
        BitLen = SHIFTL(ToLong(MD%GetBlockCount()), 10) + SHIFTL(ToLong(Ptr), 3)
...
#define KB(j)       (j * ToLong(Z'0555555555555555'))
