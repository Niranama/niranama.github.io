...
!** USE STATEMENTS:
    ...
    USE Class_MDEngine
    USE Class_SIMDS,        ONLY: MaskI8, MaskI16, AlphaTab
...
!** MODULE PARAMETERS:
    ...
    tInteger, PARAMETER :: IV384(0:31) = [              &
        ToInteger(Z'8A36EEBC'), ToInteger(Z'94A3BD90'), &
        ToInteger(Z'D1537B83'), ToInteger(Z'B25B070B'), &
        ToInteger(Z'F463F1B5'), ToInteger(Z'B6F81E20'), &
        ToInteger(Z'0055C339'), ToInteger(Z'B4D144D1'), &
        ToInteger(Z'7360CA61'), ToInteger(Z'18361A03'), &
        ToInteger(Z'17DCB4B9'), ToInteger(Z'3414C45A'), &
        ToInteger(Z'A699A9D2'), ToInteger(Z'E39E9664'), &
        ToInteger(Z'468BFE77'), ToInteger(Z'51D062F8'), &
        ToInteger(Z'B9E3BFE8'), ToInteger(Z'63BECE2A'), &
        ToInteger(Z'8FE506B9'), ToInteger(Z'F8CC4AC2'), &
        ToInteger(Z'7AE11542'), ToInteger(Z'B1AADDA1'), &
        ToInteger(Z'64B06794'), ToInteger(Z'28D2F462'), &
        ToInteger(Z'E64071EC'), ToInteger(Z'1DEB91A8'), &
        ToInteger(Z'8AC8DB23'), ToInteger(Z'3F782AB5'), &
        ToInteger(Z'039B5CB8'), ToInteger(Z'71DDD962'), &
        ToInteger(Z'FADE2CEA'), ToInteger(Z'1416DF71')]
    tInteger, PARAMETER :: IV512(0:31) = [              &
        ToInteger(Z'0BA16B95'), ToInteger(Z'72F999AD'), &
        ToInteger(Z'9FECC2AE'), ToInteger(Z'BA3264FC'), &
        ToInteger(Z'5E894929'), ToInteger(Z'8E9F30E5'), &
        ToInteger(Z'2F1DAA37'), ToInteger(Z'F0F2C558'), &
        ToInteger(Z'AC506643'), ToInteger(Z'A90635A5'), &
        ToInteger(Z'E25B878B'), ToInteger(Z'AAB7878F'), &
        ToInteger(Z'88817F7A'), ToInteger(Z'0A02892B'), &
        ToInteger(Z'559A7550'), ToInteger(Z'598F657E'), &
        ToInteger(Z'7EEF60A1'), ToInteger(Z'6B70E3E8'), &
        ToInteger(Z'9C1714D1'), ToInteger(Z'B958E2A8'), &
        ToInteger(Z'AB02675E'), ToInteger(Z'ED1C014F'), &
        ToInteger(Z'CD8D65BB'), ToInteger(Z'FDB7A257'), &
        ToInteger(Z'09254899'), ToInteger(Z'D699C7BC'), &
        ToInteger(Z'9019B6DC'), ToInteger(Z'2B9022E4'), &
        ToInteger(Z'8FA14956'), ToInteger(Z'21BF9BD3'), &
        ToInteger(Z'B94D0943'), ToInteger(Z'6FFDDC22')]
...
! FLOW
    ...
    ASSOCIATE(TmpBuf => MD%BufArr)
        Ptr  = MD%GetBufLen()
        IF ((Ptr > 0_kIndex).OR.(NBits > 0_kByte)) THEN
        ...
        BlockCount = SHIFTL(MD%GetBlockCount(), 10) + ToLong(SHIFTL(Ptr, 3)) + ToLong(NBits)
        CALL ByteUnpackLE(ToInteger(BlockCount), TmpBuf, 0_kIndex)
        CALL ByteUnpackLE(ToInteger(SHIFTA(BlockCount, 32)), TmpBuf, 4_kIndex)
        TmpBuf(8:) = FByte00
