...
!** USE STATEMENTS:
    ...
    USE ModBase_BytePack,           ONLY: ByteUnpackBE
...
#include    "Includes/HamsiB_Constants.f90"
    tByte,    PARAMETER :: FByte00 = ToByte(Z'00')
    tByte,    PARAMETER :: FByte80 = ToByte(Z'80')
    tByte,    PARAMETER :: FByteFF = ToByte(Z'FF')
    tIndex,   PARAMETER :: DLen384  = 48_kIndex
    tIndex,   PARAMETER :: DLen512  = 64_kIndex
    tInteger, PARAMETER :: Alpha_N(0:31) = [                &
            ToInteger(Z'FF00F0F0'), ToInteger(Z'CCCCAAAA'), &
            ToInteger(Z'F0F0CCCC'), ToInteger(Z'FF00AAAA'), &
            ToInteger(Z'CCCCAAAA'), ToInteger(Z'F0F0FF00'), &
            ToInteger(Z'AAAACCCC'), ToInteger(Z'F0F0FF00'), &
            ToInteger(Z'F0F0CCCC'), ToInteger(Z'AAAAFF00'), &
            ToInteger(Z'CCCCFF00'), ToInteger(Z'AAAAF0F0'), &
            ToInteger(Z'AAAAF0F0'), ToInteger(Z'FF00CCCC'), &
            ToInteger(Z'CCCCF0F0'), ToInteger(Z'FF00AAAA'), &
            ToInteger(Z'CCCCAAAA'), ToInteger(Z'FF00F0F0'), &
            ToInteger(Z'FF00AAAA'), ToInteger(Z'F0F0CCCC'), &
            ToInteger(Z'F0F0FF00'), ToInteger(Z'CCCCAAAA'), &
            ToInteger(Z'F0F0FF00'), ToInteger(Z'AAAACCCC'), &
            ToInteger(Z'AAAAFF00'), ToInteger(Z'F0F0CCCC'), &
            ToInteger(Z'AAAAF0F0'), ToInteger(Z'CCCCFF00'), &
            ToInteger(Z'FF00CCCC'), ToInteger(Z'AAAAF0F0'), &
            ToInteger(Z'FF00AAAA'), ToInteger(Z'CCCCF0F0')]
    tInteger, PARAMETER :: Alpha_F(0:31) = [                &
            ToInteger(Z'CAF9639C'), ToInteger(Z'0FF0F9C0'), &
            ToInteger(Z'639C0FF0'), ToInteger(Z'CAF9F9C0'), &
            ToInteger(Z'0FF0F9C0'), ToInteger(Z'639CCAF9'), &
            ToInteger(Z'F9C00FF0'), ToInteger(Z'639CCAF9'), &
            ToInteger(Z'639C0FF0'), ToInteger(Z'F9C0CAF9'), &
            ToInteger(Z'0FF0CAF9'), ToInteger(Z'F9C0639C'), &
            ToInteger(Z'F9C0639C'), ToInteger(Z'CAF90FF0'), &
            ToInteger(Z'0FF0639C'), ToInteger(Z'CAF9F9C0'), &
            ToInteger(Z'0FF0F9C0'), ToInteger(Z'CAF9639C'), &
            ToInteger(Z'CAF9F9C0'), ToInteger(Z'639C0FF0'), &
            ToInteger(Z'639CCAF9'), ToInteger(Z'0FF0F9C0'), &
            ToInteger(Z'639CCAF9'), ToInteger(Z'F9C00FF0'), &
            ToInteger(Z'F9C0CAF9'), ToInteger(Z'639C0FF0'), &
            ToInteger(Z'F9C0639C'), ToInteger(Z'0FF0CAF9'), &
            ToInteger(Z'CAF90FF0'), ToInteger(Z'F9C0639C'), &
            ToInteger(Z'CAF9F9C0'), ToInteger(Z'0FF0639C')]
    tInteger, PARAMETER :: IV384(0:15) = [                  &
            ToInteger(Z'656B7472'), ToInteger(Z'6F746563'), &
            ToInteger(Z'686E6965'), ToInteger(Z'6B2C2043'), &
            ToInteger(Z'6F6D7075'), ToInteger(Z'74657220'), &
            ToInteger(Z'53656375'), ToInteger(Z'72697479'), &
            ToInteger(Z'20616E64'), ToInteger(Z'20496E64'), &
            ToInteger(Z'75737472'), ToInteger(Z'69616C20'), &
            ToInteger(Z'43727970'), ToInteger(Z'746F6772'), &
            ToInteger(Z'61706879'), ToInteger(Z'2C204B61')]
    tInteger, PARAMETER :: IV512(0:15) = [                  &
            ToInteger(Z'73746565'), ToInteger(Z'6C706172'), &
            ToInteger(Z'6B204172'), ToInteger(Z'656E6265'), &
            ToInteger(Z'72672031'), ToInteger(Z'302C2062'), &
            ToInteger(Z'75732032'), ToInteger(Z'3434362C'), &
            ToInteger(Z'20422D33'), ToInteger(Z'30303120'), &
            ToInteger(Z'4C657576'), ToInteger(Z'656E2D48'), &
            ToInteger(Z'65766572'), ToInteger(Z'6C65652C'), &
            ToInteger(Z'2042656C'), ToInteger(Z'6769756D')]
...
!** DERIVED TYPE DEFINITIONS
    ...
    TYPE, EXTENDS(BaseDigest) :: HamsiB
        ...
        !% buffer
        tByte       :: Partial(0:7) = 0_kByte
        !% number of bytes used in the buffer
        tIndex      :: PartialLen   = 0_kIndex
        !% bit count
        tLong       :: BitCount     = 0_kLong
...
! FLOW
    ...
    Ptr = MD%PartialLen
    CALL ByteUnpackBE(MD%BitCount + SHIFTL(Ptr, 3) + ToLong(NBits), Pad, 0_kIndex)
...
! FLOW
    ...
    ! initialize
    MD%BitCount = MD%BitCount + SHIFTL(ToLong(Length), 6)
    Num   = Length
    CurID = Offset
    READ_STATE_BIG(VC)
