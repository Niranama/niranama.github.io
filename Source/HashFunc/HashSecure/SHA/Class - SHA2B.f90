...
!** MODULE PARAMETERS:
    ...
    tLong,  PARAMETER   :: IV384(0:7) = [                             &
            ToLong(Z'CBBB9D5DC1059ED8'), ToLong(Z'629A292A367CD507'), &
            ToLong(Z'9159015A3070DD17'), ToLong(Z'152FECD8F70E5939'), &
            ToLong(Z'67332667FFC00B31'), ToLong(Z'8EB44A8768581511'), &
            ToLong(Z'DB0C2E0D64F98FA7'), ToLong(Z'47B5481DBEFA4FA4')]
    tLong,  PARAMETER   :: IV512(0:7) = [                             &
            ToLong(Z'6A09E667F3BCC908'), ToLong(Z'BB67AE8584CAA73B'), &
            ToLong(Z'3C6EF372FE94F82B'), ToLong(Z'A54FF53A5F1D36F1'), &
            ToLong(Z'510E527FADE682D1'), ToLong(Z'9B05688C2B3E6C1F'), &
            ToLong(Z'1F83D9ABFB41BD6B'), ToLong(Z'5BE0CD19137E2179')]
    tLong,  PARAMETER   :: K(0:79) = [                                                         &
        ToLong(Z'428A2F98D728AE22'), ToLong(Z'7137449123EF65CD'), ToLong(Z'B5C0FBCFEC4D3B2F'), &
        ToLong(Z'E9B5DBA58189DBBC'), ToLong(Z'3956C25BF348B538'), ToLong(Z'59F111F1B605D019'), &
        ToLong(Z'923F82A4AF194F9B'), ToLong(Z'AB1C5ED5DA6D8118'), ToLong(Z'D807AA98A3030242'), &
        ToLong(Z'12835B0145706FBE'), ToLong(Z'243185BE4EE4B28C'), ToLong(Z'550C7DC3D5FFB4E2'), &
        ToLong(Z'72BE5D74F27B896F'), ToLong(Z'80DEB1FE3B1696B1'), ToLong(Z'9BDC06A725C71235'), &
        ToLong(Z'C19BF174CF692694'), ToLong(Z'E49B69C19EF14AD2'), ToLong(Z'EFBE4786384F25E3'), &
        ToLong(Z'0FC19DC68B8CD5B5'), ToLong(Z'240CA1CC77AC9C65'), ToLong(Z'2DE92C6F592B0275'), &
        ToLong(Z'4A7484AA6EA6E483'), ToLong(Z'5CB0A9DCBD41FBD4'), ToLong(Z'76F988DA831153B5'), &
        ToLong(Z'983E5152EE66DFAB'), ToLong(Z'A831C66D2DB43210'), ToLong(Z'B00327C898FB213F'), &
        ToLong(Z'BF597FC7BEEF0EE4'), ToLong(Z'C6E00BF33DA88FC2'), ToLong(Z'D5A79147930AA725'), &
        ToLong(Z'06CA6351E003826F'), ToLong(Z'142929670A0E6E70'), ToLong(Z'27B70A8546D22FFC'), &
        ToLong(Z'2E1B21385C26C926'), ToLong(Z'4D2C6DFC5AC42AED'), ToLong(Z'53380D139D95B3DF'), &
        ToLong(Z'650A73548BAF63DE'), ToLong(Z'766A0ABB3C77B2A8'), ToLong(Z'81C2C92E47EDAEE6'), &
        ToLong(Z'92722C851482353B'), ToLong(Z'A2BFE8A14CF10364'), ToLong(Z'A81A664BBC423001'), &
        ToLong(Z'C24B8B70D0F89791'), ToLong(Z'C76C51A30654BE30'), ToLong(Z'D192E819D6EF5218'), &
        ToLong(Z'D69906245565A910'), ToLong(Z'F40E35855771202A'), ToLong(Z'106AA07032BBD1B8'), &
        ToLong(Z'19A4C116B8D2D0C8'), ToLong(Z'1E376C085141AB53'), ToLong(Z'2748774CDF8EEB99'), &
        ToLong(Z'34B0BCB5E19B48A8'), ToLong(Z'391C0CB3C5C95A63'), ToLong(Z'4ED8AA4AE3418ACB'), &
        ToLong(Z'5B9CCA4F7763E373'), ToLong(Z'682E6FF3D6B2B8A3'), ToLong(Z'748F82EE5DEFB2FC'), &
        ToLong(Z'78A5636F43172F60'), ToLong(Z'84C87814A1F0AB72'), ToLong(Z'8CC702081A6439EC'), &
        ToLong(Z'90BEFFFA23631E28'), ToLong(Z'A4506CEBDE82BDE9'), ToLong(Z'BEF9A3F7B2C67915'), &
        ToLong(Z'C67178F2E372532B'), ToLong(Z'CA273ECEEA26619C'), ToLong(Z'D186B8C721C0C207'), &
        ToLong(Z'EADA7DD6CDE0EB1E'), ToLong(Z'F57D4F7FEE6ED178'), ToLong(Z'06F067AA72176FBA'), &
        ToLong(Z'0A637DC5A2C898A6'), ToLong(Z'113F9804BEF90DAE'), ToLong(Z'1B710B35131C471B'), &
        ToLong(Z'28DB77F523047D84'), ToLong(Z'32CAAB7B40C72493'), ToLong(Z'3C9EBE0A15C9BEBC'), &
        ToLong(Z'431D67C49C100D4C'), ToLong(Z'4CC5D4BECB3E42B6'), ToLong(Z'597F299CFC657E2A'), &
        ToLong(Z'5FCB6FAB3AD6FAEC'), ToLong(Z'6C44198C4A475817')]
