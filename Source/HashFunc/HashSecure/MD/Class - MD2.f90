...
!** DERIVED TYPE DEFINITIONS
    ...
    TYPE, EXTENDS(MDEngine) :: MD2
        ...
        tInteger    :: X(0:47)              = 0_kInteger
        tInteger    :: C(0:15)              = 0_kInteger
        tInteger    :: L                    = 0_kInteger
    CONTAINS
...
! FLOW
    ...
    TL = MD%L
    DO I = 0, 15
        U = IAND(ToInteger(BytesIn(I)), ToInteger(Z'000000FF'))
        MD%X(16 + I) = U
    ...
    DO J = 0, 17
        DO K = 0, 47, 8
            ...
            END DO
        END DO
        T = IAND((T + J), ToInteger(Z'000000FF'))
    END DO
...
! FLOW
    ...
    DO I = 0, (15 - Pending)
        CALL MD%Update(ToByte(16_kIndex-Pending), 1_kIndex)
    END DO
    J = MD%GetBufLen()
    DO I = 0, 15
        D(I) = ToByte(MD%C(I))
    ...
    DO I = 0, 15
        BytesOut(Offset+I) = ToByte(MD%X(I))
    END DO
