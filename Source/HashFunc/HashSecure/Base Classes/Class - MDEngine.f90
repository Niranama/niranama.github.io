...
!** MODULE PARAMETERS:
    ...
    tByte, PARAMETER, PUBLIC    :: FByte00 = ToByte(Z'00')
    tByte, PARAMETER, PUBLIC    :: FByte01 = ToByte(Z'01')
    tByte, PARAMETER, PUBLIC    :: FByte80 = ToByte(Z'80')
    tByte, PARAMETER, PUBLIC    :: FByteFF = ToByte(Z'FF')
