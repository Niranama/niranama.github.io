...
SUBMODULE (ModBase_OptimalHash64) SubBase_CityHash64_Opt

!^ **PURPOSE OF THIS SUBMODULE**: <br>
!   This submodule contains an optimal implementation for the City hash algorithms
...
MODULE FUNCTION City_Hash64_Opt(Input, InpSize, StartHash, RemoveSign, Seed) RESULT(HashCode)
...
!** FLOW
    ...
    ! perform hashing
    HashCode = City_Hash64(InpPtr, Seed1, Seed)
...
END FUNCTION City_Hash64_Opt

!******************************************************************************

MODULE FUNCTION FarmNa_Hash64_Opt(Input, InpSize, StartHash, RemoveSign, Seed) RESULT(HashCode)
...
!** FLOW
    ...
    ! perform hashing
    HashCode = FarmNa_Hash64(InpPtr, Seed1, Seed)
...
END FUNCTION FarmNa_Hash64_Opt

!******************************************************************************

MODULE FUNCTION FarmUo_Hash64_Opt(Input, InpSize, StartHash, RemoveSign, Seed) RESULT(HashCode)
...
!** FLOW
    ...
    ! perform hashing
    HashCode = FarmUo_Hash64(InpPtr, Seed1, Seed)
...
END FUNCTION FarmUo_Hash64_Opt

!******************************************************************************

FUNCTION City_Hash64(Input, Seed1, Seed2) RESULT(HashCode)
...
FUNCTION FarmNa_Hash64(Input, Seed1, Seed2) RESULT(HashCode)
...
FUNCTION FarmUo_Hash64(Input, Seed1, Seed2) RESULT(HashCode)
...
!** FLOW
    ...
    IEnd = Offset + SHIFTA((Length - 1), 6)*64
    Last64 = IEnd + IAND((Length - 1), 63) - 63
...
END SUBMODULE SubBase_CityHash64_Opt
