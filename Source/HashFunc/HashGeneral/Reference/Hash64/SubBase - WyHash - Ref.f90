...
SUBMODULE (ModBase_ReferenceHash64) SubBase_WyHash_Ref

!^ **PURPOSE OF THIS SUBMODULE**: <br>
!   This submodule contains a reference implementation for the WyHash hash algorithm
!   by Wang Yi. <br>
...
!** FLOW
    ...
    ! perform hashing
    HashCode = WyV3_Hash64(InpPtr, Seed, ByteConv)
...
!** FLOW
    ...
    ! perform hashing
    HashCode = WyF3_Hash64(InpPtr, Seed, ByteConv)
...
FUNCTION WyV3_Hash64(Input, Seed, BC) RESULT(HashCode)
...
#define WyR3(In, Index, K) \
    IOR(IOR(SHIFTL(ToLong(BC%Get_U8(In, Index)), 16),                   \
            SHIFTL(ToLong(BC%Get_U8(In, Index + SHIFTR(K, 1))), 8)),    \
                   ToLong(BC%Get_U8(In, Index + K - 1)))
#define U64Rotate32(In, Index)  \
    IOR(SHIFTL(BC%Pack_U32(In, Index), 32), \
        BC%Pack_U32(In, Index + 4))
...
!** FLOW
    ...
    ELSEIF (Length <= 8) THEN
        LHS1 = IEOR(IEOR(BC%Pack_U32(Input, Offset), Seed1), WyP0)
        RHS1 = IEOR(IEOR(BC%Pack_U32(Input, Offset+Length-4), Seed1), WyP1)
        LHS2 = IEOR(WyMum(LHS1, RHS1), Seed1)
        RHS2 = IEOR(ToLong(Length), WyP4)
        HashCode = WyMum(LHS2, RHS2)
    ...
    ELSE
        ...
        P = Offset
        DO WHILE(I > 256)
            LHS1 = IEOR(IEOR(BC%Pack_I64(Input, P), Seed1), WyP0)
            RHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+8), Seed1), WyP1)
            LHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+16), Seed1), WyP2)
            RHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+24), Seed1), WyP3)
            Seed1 = IEOR(WyMum(LHS1, RHS1), WyMum(LHS2, RHS2))

            LHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+32), Seed2), WyP1)
            RHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+40), Seed2), WyP2)
            LHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+48), Seed2), WyP3)
            RHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+56), Seed2), WyP0)
            Seed2 = IEOR(WyMum(LHS1, RHS1), WyMum(LHS2, RHS2))

            LHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+64), Seed1), WyP0)
            RHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+72), Seed1), WyP1)
            LHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+80), Seed1), WyP2)
            RHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+88), Seed1), WyP3)
            Seed1 = IEOR(WyMum(LHS1, RHS1), WyMum(LHS2, RHS2))

            LHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+96), Seed2), WyP1)
            RHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+104), Seed2), WyP2)
            LHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+112), Seed2), WyP3)
            RHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+120), Seed2), WyP0)
            Seed2 = IEOR(WyMum(LHS1, RHS1), WyMum(LHS2, RHS2))

            LHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+128), Seed1), WyP0)
            RHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+136), Seed1), WyP1)
            LHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+144), Seed1), WyP2)
            RHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+152), Seed1), WyP3)
            Seed1 = IEOR(WyMum(LHS1, RHS1), WyMum(LHS2, RHS2))

            LHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+160), Seed2), WyP1)
            RHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+168), Seed2), WyP2)
            LHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+176), Seed2), WyP3)
            RHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+184), Seed2), WyP0)
            Seed2 = IEOR(WyMum(LHS1, RHS1), WyMum(LHS2, RHS2))

            LHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+192), Seed1), WyP0)
            RHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+200), Seed1), WyP1)
            LHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+208), Seed1), WyP2)
            RHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+216), Seed1), WyP3)
            Seed1 = IEOR(WyMum(LHS1, RHS1), WyMum(LHS2, RHS2))

            LHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+224), Seed2), WyP1)
            RHS1 = IEOR(IEOR(BC%Pack_I64(Input, P+232), Seed2), WyP2)
            LHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+240), Seed2), WyP3)
            RHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+248), Seed2), WyP0)
            Seed2 = IEOR(WyMum(LHS1, RHS1), WyMum(LHS2, RHS2))
        ...
        DO WHILE(I  > 32)
            ...
            LHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+16), Seed2), WyP2)
            RHS2 = IEOR(IEOR(BC%Pack_I64(Input, P+24), Seed2), WyP3)
        ...
        ELSEIF (I <= 8)  THEN
            Seed1 = WyMum(IEOR(IEOR(BC%Pack_U32(Input, P), Seed1), WyP0), \
                          IEOR(IEOR(BC%Pack_U32(Input, P+I-4), Seed1), WyP1))
        ELSEIF (I <= 16)  THEN
...
FUNCTION WyF3_Hash64(Input, SeedForHash, BC) RESULT(HashCode)
...
#define WyR3(In, Index, K) \
    IOR(IOR(SHIFTL(ToLong(BC%Get_U8(In, Index)), 16),                \
            SHIFTL(ToLong(BC%Get_U8(In, Index + SHIFTR(K, 1))), 8)), \
                   ToLong(BC%Get_U8(In, Index + K - 1)))
#define WyR4(In, Index)     BC%Pack_U32(In, Index)
...
!** FLOW
    ...
    ELSE
        ...
        IF (Remaining > 48) THEN
            ...
            Seed2 = Seed
            DO
                LHS1 = IEOR(BC%Pack_I64(Input, Offset), Secret1)
                RHS1 = IEOR(BC%Pack_I64(Input, Offset + 8), Seed)
                Seed = WyMix(LHS1, RHS1)
                LHS1 = IEOR(BC%Pack_I64(Input, Offset + 16), Secret2)
                RHS1 = IEOR(BC%Pack_I64(Input, Offset + 24), Seed1)
                Seed1 = WyMix(LHS1, RHS1)
                LHS1 = IEOR(BC%Pack_I64(Input, Offset + 32), Secret3)
                RHS1 = IEOR(BC%Pack_I64(Input, Offset + 40), Seed2)
        ...
        DO WHILE (Remaining > 16)
            ...
            Offset = Offset + 16
        END DO
        A = BC%Pack_I64(Input, Offset + Remaining - 16)
        B = BC%Pack_I64(Input, Offset + Remaining - 8)
    END IF
    LHS1 = IEOR(A, Secret1)
    RHS1 = IEOR(B, Seed)
...
END SUBMODULE SubBase_WyHash_Ref
