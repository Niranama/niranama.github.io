...
!   END DO
!   </Code></Pre>
!   See the <a href="../module/modbase_sortascend.html">ModBase_SortAscend</a> and the
!   <a href="../module/modbase_sortdescend.html">ModBase_SortDescend</a> modules for
!   routines that perform sorting of an array in an *ascending* and *descending* order,
!   respectively.  The *ModBase_SortAscend* module also gives an overview of available
...
!** MODULE PARAMETERS:
    tCharParam  :: ModName = 'ModBase_Ranking'
