...
!   the <a href="../module/modbase_ranking.html">ModBase_Ranking</a> module for routines
...
!** MODULE PARAMETERS:
    tCharParam  :: ModName = 'ModBase_SortAscend'
