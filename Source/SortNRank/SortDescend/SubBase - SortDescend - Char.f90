...
SUBMODULE (ModBase_SortDescend) SubBase_SortDescend_Char
...
#define COMPARE_GLT(A, B)           LGT(A, B)
#define COMPARE_GLE(A, B)           LGE(A, B)
#define Is_Array_Sorted             IsSortedDescend_Char
...
END SUBMODULE SubBase_SortDescend_Char
